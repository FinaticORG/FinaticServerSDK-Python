...
from ..models.cancel_order_api_beta_brokers_orders_order_id_delete_request import (
    CancelOrderApiBetaBrokersOrdersOrderIdDeleteRequest,
)
from ..models.finatic_response_disconnect_company_from_broker_connection_result import (
...
from ..models.finatic_response_list_fdx_broker_order import (
    FinaticResponseListFDXBrokerOrder,
)
from ..models.finatic_response_list_fdx_broker_order_event import (
    FinaticResponseListFDXBrokerOrderEvent,
)
from ..models.finatic_response_list_fdx_broker_order_fill import (
    FinaticResponseListFDXBrokerOrderFill,
)
from ..models.finatic_response_list_fdx_broker_order_group import (
    FinaticResponseListFDXBrokerOrderGroup,
)
from ..models.finatic_response_list_fdx_broker_position import (
    FinaticResponseListFDXBrokerPosition,
)
from ..models.finatic_response_list_fdx_broker_position_lot import (
    FinaticResponseListFDXBrokerPositionLot,
)
from ..models.finatic_response_list_fdx_broker_position_lot_fill import (
    FinaticResponseListFDXBrokerPositionLotFill,
)
from ..models.finatic_response_list_fdx_broker_transaction import (
    FinaticResponseListFDXBrokerTransaction,
)
from ..models.finatic_response_list_legacy_broker_account import (
    FinaticResponseListLegacyBrokerAccount,
)
from ..models.finatic_response_list_legacy_broker_balance import (
    FinaticResponseListLegacyBrokerBalance,
)
from ..models.finatic_response_list_user_broker_connection_with_permissions import (
...
class BrokersApi:
    ...
    async def cancel_order_api_beta_brokers_orders_order_id_delete(
        ...
        cancel_order_api_beta_brokers_orders_order_id_delete_request: CancelOrderApiBetaBrokersOrdersOrderIdDeleteRequest | None = None,
    ...
    async def get_accounts_api_beta_brokers_data_accounts_get(
        self,
        broker_id: Annotated[StrictStr | None, Field(description="Filter by broker ID")] = None,
        connection_id: Annotated[UUID | None, Field(description="Filter by connection ID")] = None,
        account_type: Annotated[Any | None, Field(description="Filter by account type (e.g., 'margin', 'cash', 'crypto_wallet', 'live', 'sim')")] = None,
        currency: Annotated[StrictStr | None, Field(description="Filter by currency (e.g., 'USD', 'EUR')")] = None,
        limit: Annotated[Annotated[int, Field(le=1000, strict=True, ge=1)] | None, Field(description="Maximum number of accounts to return")] = None,
        offset: Annotated[Annotated[int, Field(strict=True, ge=0)] | None, Field(description="Number of accounts to skip for pagination")] = None,
        include_metadata: Annotated[StrictBool | None, Field(description="Include connection metadata in response (excluded by default for FDX compliance)")] = None,
        _request_timeout: None | Annotated[StrictFloat, Field(gt=0)] | tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]] = None,
        _request_auth: dict[StrictStr, Any] | None = None,
        _content_type: StrictStr | None = None,
        _headers: dict[StrictStr, Any] | None = None,
    ...
    async def get_balances_api_beta_brokers_data_balances_get(
        ...
        broker_id: Annotated[StrictStr | None, Field(description="Filter by broker ID")] = None,
        connection_id: Annotated[UUID | None, Field(description="Filter by connection ID")] = None,
        account_id: Annotated[StrictStr | None, Field(description="Filter by broker provided account ID or internal account UUID")] = None,
        unit_code: Annotated[StrictStr | None, Field(description="Filter by unit code (preferred, e.g., 'USD', 'BTC', 'ETH')")] = None,
        currency: Annotated[StrictStr | None, Field(description="Filter by currency (for FDX fiat filtering only, e.g., 'USD', 'EUR')")] = None,
        limit: Annotated[Annotated[int, Field(le=1000, strict=True, ge=1)] | None, Field(description="Maximum number of balances to return")] = None,
        offset: Annotated[Annotated[int, Field(strict=True, ge=0)] | None, Field(description="Number of balances to skip for pagination")] = None,
        include_metadata: Annotated[StrictBool | None, Field(description="Include balance metadata in response (excluded by default for FDX compliance)")] = None,
        _request_timeout: None | Annotated[StrictFloat, Field(gt=0)] | tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]] = None,
        _request_auth: dict[StrictStr, Any] | None = None,
        _content_type: StrictStr | None = None,
        _headers: dict[StrictStr, Any] | None = None,
    ...
    async def get_order_events_api_beta_brokers_data_orders_order_id_events_get(
        ...
        connection_id: Annotated[UUID | None, Field(description="Filter by connection ID")] = None,
        limit: Annotated[Annotated[int, Field(le=1000, strict=True, ge=1)] | None, Field(description="Maximum number of events to return")] = None,
        offset: Annotated[Annotated[int, Field(strict=True, ge=0)] | None, Field(description="Number of events to skip for pagination")] = None,
        include_metadata: Annotated[StrictBool | None, Field(description="Include event metadata in response (excluded by default for FDX compliance)")] = None,
        _request_timeout: None | Annotated[StrictFloat, Field(gt=0)] | tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]] = None,
        _request_auth: dict[StrictStr, Any] | None = None,
        _content_type: StrictStr | None = None,
        _headers: dict[StrictStr, Any] | None = None,
    ...
    async def get_order_fills_api_beta_brokers_data_orders_order_id_fills_get(
        ...
        order_id: Annotated[UUID, Field(description="Order ID")],
        connection_id: Annotated[UUID | None, Field(description="Filter by connection ID")] = None,
        limit: Annotated[Annotated[int, Field(le=1000, strict=True, ge=1)] | None, Field(description="Maximum number of fills to return")] = None,
        offset: Annotated[Annotated[int, Field(strict=True, ge=0)] | None, Field(description="Number of fills to skip for pagination")] = None,
        include_metadata: Annotated[StrictBool | None, Field(description="Include fill metadata in response (excluded by default for FDX compliance)")] = None,
        _request_timeout: None | Annotated[StrictFloat, Field(gt=0)] | tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]] = None,
        _request_auth: dict[StrictStr, Any] | None = None,
        _content_type: StrictStr | None = None,
        _headers: dict[StrictStr, Any] | None = None,
    ...
    async def get_order_groups_api_beta_brokers_data_orders_groups_get(
        ...
        broker_id: Annotated[StrictStr | None, Field(description="Filter by broker ID")] = None,
        connection_id: Annotated[UUID | None, Field(description="Filter by connection ID")] = None,
        limit: Annotated[Annotated[int, Field(le=1000, strict=True, ge=1)] | None, Field(description="Maximum number of order groups to return")] = None,
        offset: Annotated[Annotated[int, Field(strict=True, ge=0)] | None, Field(description="Number of order groups to skip for pagination")] = None,
        created_after: Annotated[datetime | None, Field(description="Filter order groups created after this timestamp")] = None,
        created_before: Annotated[datetime | None, Field(description="Filter order groups created before this timestamp")] = None,
        include_metadata: Annotated[StrictBool | None, Field(description="Include group metadata in response (excluded by default for FDX compliance)")] = None,
        _request_timeout: None | Annotated[StrictFloat, Field(gt=0)] | tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]] = None,
        _request_auth: dict[StrictStr, Any] | None = None,
        _content_type: StrictStr | None = None,
        _headers: dict[StrictStr, Any] | None = None,
    ...
    async def get_orders_api_beta_brokers_data_orders_get(
        ...
        connection_id: Annotated[UUID | None, Field(description="Filter by connection ID")] = None,
        account_id: Annotated[StrictStr | None, Field(description="Filter by broker provided account ID or internal account UUID")] = None,
        symbol: Annotated[StrictStr | None, Field(description="Filter by symbol")] = None,
        order_status: Annotated[StrictStr | None, Field(description="Filter by order status (e.g., 'filled', 'pending_new', 'cancelled')")] = None,
        side: Annotated[Any | None, Field(description="Filter by order side (e.g., 'buy', 'sell')")] = None,
        asset_type: Annotated[Any | None, Field(description="Filter by asset type (e.g., 'stock', 'option', 'crypto', 'future')")] = None,
        limit: Annotated[Annotated[int, Field(le=1000, strict=True, ge=1)] | None, Field(description="Maximum number of orders to return")] = None,
        offset: Annotated[Annotated[int, Field(strict=True, ge=0)] | None, Field(description="Number of orders to skip for pagination")] = None,
        created_after: Annotated[datetime | None, Field(description="Filter orders created after this timestamp")] = None,
        created_before: Annotated[datetime | None, Field(description="Filter orders created before this timestamp")] = None,
        include_metadata: Annotated[StrictBool | None, Field(description="Include order metadata in response (excluded by default for FDX compliance)")] = None,
        _request_timeout: None | Annotated[StrictFloat, Field(gt=0)] | tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]] = None,
        _request_auth: dict[StrictStr, Any] | None = None,
        _content_type: StrictStr | None = None,
        _headers: dict[StrictStr, Any] | None = None,
    ...
    async def get_position_lots_api_beta_brokers_data_positions_lots_get(
        ...
        broker_id: Annotated[StrictStr | None, Field(description="Filter by broker ID")] = None,
        connection_id: Annotated[UUID | None, Field(description="Filter by connection ID")] = None,
        account_id: Annotated[StrictStr | None, Field(description="Filter by broker provided account ID")] = None,
        symbol: Annotated[StrictStr | None, Field(description="Filter by symbol")] = None,
        position_id: Annotated[UUID | None, Field(description="Filter by position ID")] = None,
        limit: Annotated[Annotated[int, Field(le=1000, strict=True, ge=1)] | None, Field(description="Maximum number of position lots to return")] = None,
        offset: Annotated[Annotated[int, Field(strict=True, ge=0)] | None, Field(description="Number of position lots to skip for pagination")] = None,
        _request_timeout: None | Annotated[StrictFloat, Field(gt=0)] | tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]] = None,
        _request_auth: dict[StrictStr, Any] | None = None,
        _content_type: StrictStr | None = None,
        _headers: dict[StrictStr, Any] | None = None,
    ...
    async def get_positions_api_beta_brokers_data_positions_get(
        ...
        account_id: Annotated[StrictStr | None, Field(description="Filter by broker provided account ID or internal account UUID")] = None,
        symbol: Annotated[StrictStr | None, Field(description="Filter by symbol")] = None,
        side: Annotated[Any | None, Field(description="Filter by position side (e.g., 'long', 'short')")] = None,
        asset_type: Annotated[Any | None, Field(description="Filter by asset type (e.g., 'stock', 'option', 'crypto', 'future')")] = None,
        position_status: Annotated[Any | None, Field(description="Filter by position status: 'active' (open positions) or 'closed' (closed positions). Use 'all' or omit to get both.")] = None,
        limit: Annotated[Annotated[int, Field(le=1000, strict=True, ge=1)] | None, Field(description="Maximum number of positions to return")] = None,
        offset: Annotated[Annotated[int, Field(strict=True, ge=0)] | None, Field(description="Number of positions to skip for pagination")] = None,
        updated_after: Annotated[datetime | None, Field(description="Filter positions updated after this timestamp")] = None,
        updated_before: Annotated[datetime | None, Field(description="Filter positions updated before this timestamp")] = None,
        include_metadata: Annotated[StrictBool | None, Field(description="Include position metadata in response (excluded by default for FDX compliance)")] = None,
        _request_timeout: None | Annotated[StrictFloat, Field(gt=0)] | tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]] = None,
        _request_auth: dict[StrictStr, Any] | None = None,
        _content_type: StrictStr | None = None,
        _headers: dict[StrictStr, Any] | None = None,
    ...
    async def get_transactions_api_beta_brokers_data_transactions_get(
        ...
        unit_code: Annotated[StrictStr | None, Field(description="Filter by unit code (preferred, e.g., 'USD', 'BTC', 'ETH')")] = None,
        currency: Annotated[StrictStr | None, Field(description="Filter by currency (for FDX fiat filtering only, e.g., 'USD', 'EUR')")] = None,
        transaction_type: Annotated[StrictStr | None, Field(description="Filter by transaction type (e.g., 'DEPOSIT', 'WITHDRAWAL', 'DIVIDEND')")] = None,
        start_date: Annotated[datetime | None, Field(description="Filter transactions from this date (ISO 8601)")] = None,
        end_date: Annotated[datetime | None, Field(description="Filter transactions until this date (ISO 8601)")] = None,
        limit: Annotated[Annotated[int, Field(le=1000, strict=True, ge=1)] | None, Field(description="Maximum number of transactions to return")] = None,
        offset: Annotated[Annotated[int, Field(strict=True, ge=0)] | None, Field(description="Number of transactions to skip for pagination")] = None,
        _request_timeout: None | Annotated[StrictFloat, Field(gt=0)] | tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]] = None,
        _request_auth: dict[StrictStr, Any] | None = None,
        _content_type: StrictStr | None = None,
        _headers: dict[StrictStr, Any] | None = None,
    ...
    async def modify_order_api_beta_brokers_orders_order_id_patch(
        ...
        connection_id: Annotated[UUID | None, Field(description="Temporary bypass for testing: specify connection ID directly")] = None,
        _request_timeout: None | Annotated[StrictFloat, Field(gt=0)] | tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]] = None,
        _request_auth: dict[StrictStr, Any] | None = None,
        _content_type: StrictStr | None = None,
        _headers: dict[StrictStr, Any] | None = None,
    ...
    async def place_order_api_beta_brokers_orders_post(
        self,
        connection_id: Annotated[UUID | None, Field(description="Temporary bypass for testing: specify connection ID directly")] = None,
        place_order_api_beta_brokers_orders_post_request: PlaceOrderApiBetaBrokersOrdersPostRequest | None = None,
        _request_timeout: None | Annotated[StrictFloat, Field(gt=0)] | tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]] = None,
        _request_auth: dict[StrictStr, Any] | None = None,
        _content_type: StrictStr | None = None,
        _headers: dict[StrictStr, Any] | None = None,
