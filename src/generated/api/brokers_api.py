...
class BrokersApi:
    ...
    async def cancel_order_api_v1_brokers_orders_order_id_delete(
        ...
        account_number: Annotated[
            Optional[StrictStr], Field(description="Account number owning the order")
        ] = None,
        ...
        cancel_order_api_v1_brokers_orders_order_id_delete_request: Optional[
            CancelOrderApiV1BrokersOrdersOrderIdDeleteRequest
        ] = None,
    ...
    async def get_accounts_api_v1_brokers_data_accounts_get(
        ...
        account_type: Annotated[
            Optional[PublicAccountTypeEnum],
            Field(
        ...
        status: Annotated[
            ...
            Field(description="Filter by account status (e.g., 'active', 'inactive')"),
        ] = None,
        currency: Annotated[
            Optional[StrictStr],
        ...
        with_metadata: Annotated[
            Optional[StrictBool],
            Field(description="Include connection metadata in response"),
        ] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    async def get_balances_api_v1_brokers_data_balances_get(
        ...
        is_end_of_day_snapshot: Annotated[
            Optional[StrictBool],
            Field(description="Filter by end-of-day snapshot status (true/false)"),
        ] = None,
        limit: Annotated[
            Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]],
        ...
        balance_created_after: Annotated[
            Optional[datetime],
            Field(description="Filter balances created after this timestamp"),
        ] = None,
        balance_created_before: Annotated[
            Optional[datetime],
            Field(description="Filter balances created before this timestamp"),
        ] = None,
        with_metadata: Annotated[
            Optional[StrictBool],
            Field(description="Include balance metadata in response"),
        ] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    async def get_orders_api_v1_brokers_data_orders_get(
        ...
        created_after: Annotated[
            Optional[datetime],
            Field(description="Filter orders created after this timestamp"),
        ] = None,
        created_before: Annotated[
            Optional[datetime],
            Field(description="Filter orders created before this timestamp"),
        ] = None,
        with_metadata: Annotated[
            Optional[StrictBool],
            Field(description="Include order metadata in response"),
        ] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    async def get_position_lots_api_v1_brokers_data_positions_lots_get(
        ...
        _param = (
            self._get_position_lots_api_v1_brokers_data_positions_lots_get_serialize(
                broker_id=broker_id,
                connection_id=connection_id,
                account_id=account_id,
                symbol=symbol,
    ...
    async def get_positions_api_v1_brokers_data_positions_get(
        ...
        position_status: Annotated[
            Optional[PublicPositionStatusEnum],
            Field(
                description="Filter by position status: 'open' (quantity > 0) or 'closed' (quantity = 0)"
            ),
        ] = None,
        limit: Annotated[
            Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]],
        ...
        with_metadata: Annotated[
            Optional[StrictBool],
            Field(description="Include position metadata in response"),
        ] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    async def modify_order_api_v1_brokers_orders_order_id_patch(
        ...
        modify_order_api_v1_brokers_orders_order_id_patch_request: Optional[
            ModifyOrderApiV1BrokersOrdersOrderIdPatchRequest
        ] = None,
        _request_timeout: Union[
            None,
    ...
    async def place_order_api_v1_brokers_orders_post(
        ...
        place_order_api_v1_brokers_orders_post_request: Optional[
            PlaceOrderApiV1BrokersOrdersPostRequest
        ] = None,
        _request_timeout: Union[
            None,
