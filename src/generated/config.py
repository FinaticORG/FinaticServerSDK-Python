...
class SdkConfig:
    ...
    base_url: str = field(
        default_factory=lambda: os.getenv("FINATIC_API_URL", "https://api.finatic.com")
    )
    ...
    retry_enabled: bool = field(
        default_factory=lambda: os.getenv("FINATIC_RETRY_ENABLED", "true").lower()
        != "false"
    )
    ...
    retry_on_network_error: bool = field(
        default_factory=lambda: os.getenv(
            "FINATIC_RETRY_ON_NETWORK_ERROR", "true"
        ).lower()
        != "false"
    )
    ...
    structured_logging: bool = field(
        default_factory=lambda: os.getenv("FINATIC_STRUCTURED_LOGGING", "false").lower()
        == "true"
    )
    log_request_body: bool = field(
        default_factory=lambda: os.getenv("FINATIC_LOG_REQUEST_BODY", "false").lower()
        == "true"
    )
    log_response_body: bool = field(
        default_factory=lambda: os.getenv("FINATIC_LOG_RESPONSE_BODY", "false").lower()
        == "true"
    )
    log_request_id: bool = field(
        default_factory=lambda: os.getenv("FINATIC_LOG_REQUEST_ID", "true").lower()
        != "false"
    )
    ...
    validation_enabled: bool = field(
        default_factory=lambda: os.getenv("FINATIC_VALIDATION_ENABLED", "true").lower()
        != "false"
    )
    validation_strict: bool = field(
        default_factory=lambda: os.getenv("FINATIC_VALIDATION_STRICT", "false").lower()
        == "true"
    )
    ...
    cache_enabled: bool = field(
        default_factory=lambda: os.getenv("FINATIC_CACHE_ENABLED", "false").lower()
        == "true"
    )
    cache_ttl: int = field(
    ...
    rate_limit_enabled: bool = field(
        default_factory=lambda: os.getenv("FINATIC_RATE_LIMIT_ENABLED", "true").lower()
        != "false"
    )
    rate_limit_auto_retry: bool = field(
        default_factory=lambda: os.getenv(
            "FINATIC_RATE_LIMIT_AUTO_RETRY", "true"
        ).lower()
        != "false"
    )
    ...
    request_interceptors_enabled: bool = field(
        default_factory=lambda: os.getenv(
            "FINATIC_REQUEST_INTERCEPTORS", "true"
        ).lower()
        != "false"
    )
    response_interceptors_enabled: bool = field(
        default_factory=lambda: os.getenv(
            "FINATIC_RESPONSE_INTERCEPTORS", "true"
        ).lower()
        != "false"
    )
