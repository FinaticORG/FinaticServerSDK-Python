...
class Accounts(BaseModel):
    ...
    api_key_hash: StrictStr | None = None
    api_key_last_used_at: datetime | None = None
    compliance_agreement: StrictBool | None = None
    created_at: datetime | None
    created_by: UUID | None = None
    email: StrictStr | None = None
    is_personal_account: StrictBool
    name: StrictStr
    onboarding_completed: StrictBool | None = None
    onboarding_step: StrictInt | None = None
    picture_url: StrictStr | None = None
    primary_owner_user_id: UUID
    public_data: Any | None
    referral_source: StrictStr | None = None
    sandbox_api_key_hash: StrictStr | None = None
    sandbox_key_created_at: datetime | None = None
    sandbox_key_expires_at: datetime | None = None
    sandbox_key_last_used_at: datetime | None = None
    slug: StrictStr | None = None
    terms_accepted_at: datetime | None = None
    trading_enabled: StrictBool | None = None
    trading_usage_description: StrictStr | None = None
    updated_at: datetime | None
    updated_by: UUID | None = None
    use_case_features: dict[str, Any] | None = None
