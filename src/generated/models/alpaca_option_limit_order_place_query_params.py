...
class AlpacaOptionLimitOrderPlaceQueryParams(BaseModel):
    """Option limit order.
    """ # noqa: E501
    ...
    __properties: ClassVar[list[str]] = ["orderType", "assetType", "action", "timeInForce", "symbol", "orderQty", "price", "client_order_id", "extended_hours", "order_class", "notional", "take_profit", "stop_loss", "legs"]
    ...
    def from_json(cls, json_str: str) -> Self | None:
        """Create an instance of AlpacaOptionLimitOrderPlaceQueryParams from a JSON string"""
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        """Create an instance of AlpacaOptionLimitOrderPlaceQueryParams from a dict"""
        if obj is None:
            return None
