...
class AlpacaOptionMarketOrderPlaceQueryParams(BaseModel):
    """Option market order.
    """ # noqa: E501
    ...
    __properties: ClassVar[list[str]] = ["orderType", "assetType", "action", "timeInForce", "symbol", "orderQty", "client_order_id", "extended_hours", "order_class", "notional", "take_profit", "stop_loss", "legs"]
    ...
    def from_json(cls, json_str: str) -> Self | None:
        """Create an instance of AlpacaOptionMarketOrderPlaceQueryParams from a JSON string"""
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        """Create an instance of AlpacaOptionMarketOrderPlaceQueryParams from a dict"""
        if obj is None:
            return None
