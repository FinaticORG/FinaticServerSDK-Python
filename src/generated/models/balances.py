...
class Balances(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # and model_fields_set contains the field
        if (
            self.balance_updated_at is None
            and "balance_updated_at" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.is_end_of_day_snapshot is None
            and "is_end_of_day_snapshot" in self.model_fields_set
        ):
        ...
        _obj = cls.model_validate(
            {
                ...
                "raw_payload": (
                    obj["raw_payload"] if obj.get("raw_payload") is not None else None
                ),
