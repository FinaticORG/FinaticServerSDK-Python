...
class BrokerInfo(BaseModel):
    ...
    kind: StrictStr | None = 'broker'
    is_beta: StrictBool | None = False
    is_alpha: StrictBool | None = False
    is_disabled: StrictBool | None = False
    is_alias: StrictBool | None = False
    base_broker_id: StrictStr | None = None
    supports_trading: StrictBool | None = True
    api_passphrase_required: StrictBool | None = False
    api_passphrase_optional: StrictBool | None = False
    additional_properties: dict[str, Any] = {}
    __properties: ClassVar[list[str]] = ["id", "name", "display_name", "description", "website", "features", "auth_type", "logo_path", "is_active", "kind", "is_beta", "is_alpha", "is_disabled", "is_alias", "base_broker_id", "supports_trading", "api_passphrase_required", "api_passphrase_optional"]
