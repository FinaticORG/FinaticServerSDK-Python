...
class BrokerInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "display_name", "description", "website", "features", "auth_type", "logo_path", "is_active", "kind", "is_beta", "is_alias", "base_broker_id", "supports_trading", "api_passphrase_required", "api_passphrase_optional"]
