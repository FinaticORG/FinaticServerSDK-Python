...
CANCELORDERAPIBETABROKERSORDERSORDERIDDELETEREQUEST_ONE_OF_SCHEMAS = ["AlpacaOrderCancelRequest", "NinjaTraderOrderCancelRequest", "RobinhoodOrderCancelRequest", "TastyTradeOrderCancelRequest", "TradestationOrderCancelRequest", "Trading212OrderCancelRequest", "WebullOrderCancelRequest"]
...
class CancelOrderApiBetaBrokersOrdersOrderIdDeleteRequest(BaseModel):
    ...
    oneof_schema_1_validator: AlpacaOrderCancelRequest | None = None
    # data type: NinjaTraderOrderCancelRequest
    oneof_schema_2_validator: NinjaTraderOrderCancelRequest | None = None
    # data type: TastyTradeOrderCancelRequest
    oneof_schema_3_validator: TastyTradeOrderCancelRequest | None = None
    # data type: RobinhoodOrderCancelRequest
    oneof_schema_4_validator: RobinhoodOrderCancelRequest | None = None
    # data type: TradestationOrderCancelRequest
    oneof_schema_5_validator: TradestationOrderCancelRequest | None = None
    # data type: Trading212OrderCancelRequest
    oneof_schema_6_validator: Trading212OrderCancelRequest | None = None
    # data type: WebullOrderCancelRequest
    oneof_schema_7_validator: WebullOrderCancelRequest | None = None
    actual_instance: AlpacaOrderCancelRequest | NinjaTraderOrderCancelRequest | RobinhoodOrderCancelRequest | TastyTradeOrderCancelRequest | TradestationOrderCancelRequest | Trading212OrderCancelRequest | WebullOrderCancelRequest | None = None
    one_of_schemas: set[str] = { "AlpacaOrderCancelRequest", "NinjaTraderOrderCancelRequest", "RobinhoodOrderCancelRequest", "TastyTradeOrderCancelRequest", "TradestationOrderCancelRequest", "Trading212OrderCancelRequest", "WebullOrderCancelRequest" }
    ...
    def to_dict(self) -> dict[str, Any] | AlpacaOrderCancelRequest | NinjaTraderOrderCancelRequest | RobinhoodOrderCancelRequest | TastyTradeOrderCancelRequest | TradestationOrderCancelRequest | Trading212OrderCancelRequest | WebullOrderCancelRequest | None:
