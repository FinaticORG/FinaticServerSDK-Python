...
class FDXBrokerOrder(BaseModel):
    ...
    id: StrictStr | None = Field(default=None, alias="_id")
    ...
    client_order_id: StrictStr | None = Field(default=None, alias="clientOrderId")
    ...
    order_class: Orderclass | None = Field(default=None, alias="orderClass")
    time_in_force: Timeinforce | None = Field(default=None, alias="timeInForce")
    status: Status
    state: StrictStr | None = None
    legs: list[FDXOrderLeg] | None = Field(default=None, description="Multi-leg orders")
    order_group_id: StrictStr | None = Field(default=None, alias="orderGroupId")
    order_created_at: datetime | None = Field(default=None, alias="orderCreatedAt")
    order_live_at: datetime | None = Field(default=None, alias="orderLiveAt")
    order_updated_at: datetime | None = Field(default=None, alias="orderUpdatedAt")
    order_terminal_at: datetime | None = Field(default=None, alias="orderTerminalAt")
