...
class FDXBrokerOrderEvent(BaseModel):
    ...
    event_category: StrictStr | None = Field(default=None, alias="eventCategory")
    order_status: Orderstatus | None = Field(default=None, alias="orderStatus")
    previous_status: Previousstatus | None = Field(default=None, alias="previousStatus")
    ...
    related_order_id: StrictStr | None = Field(default=None, alias="relatedOrderId")
    related_event_id: StrictStr | None = Field(default=None, alias="relatedEventId")
    inferred: StrictBool | None = None
    confidence: Annotated[float, Field(le=1, strict=True, ge=0)] | Annotated[int, Field(le=1, strict=True, ge=0)] | None = None
    reason_code: StrictStr | None = Field(default=None, alias="reasonCode")
    affected_legs: list[StrictInt] | None = Field(default=None, alias="affectedLegs")
