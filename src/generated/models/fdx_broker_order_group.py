...
class FDXBrokerOrderGroup(BaseModel):
    ...
    group_status: StrictStr | None = Field(default=None, alias="groupStatus")
    orders: list[FDXOrderGroupOrder] | None = Field(default=None, description="Orders in this group")
