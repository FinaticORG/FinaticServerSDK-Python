...
class FDXBrokerPosition(BaseModel):
    ...
    internal_account_id: StrictStr | None = Field(default=None, alias="internalAccountId")
    ...
    cost_basis: Costbasis | None = Field(default=None, alias="costBasis")
    market_value: Marketvalue | None = Field(default=None, alias="marketValue")
    units: Units | None = None
    average_buy_price: Averagebuyprice | None = Field(default=None, alias="averageBuyPrice")
    average_sell_price: Averagesellprice | None = Field(default=None, alias="averageSellPrice")
    cost_basis_with_commission: Costbasiswithcommission | None = Field(default=None, alias="costBasisWithCommission")
    current_price: Currentprice | None = Field(default=None, alias="currentPrice")
    realized_profit_loss: Realizedprofitloss | None = Field(default=None, alias="realizedProfitLoss")
    realized_profit_loss_with_commission: Realizedprofitlosswithcommission | None = Field(default=None, alias="realizedProfitLossWithCommission")
    realized_profit_loss_percent: Realizedprofitlosspercent | None = Field(default=None, alias="realizedProfitLossPercent")
    unrealized_profit_loss: Unrealizedprofitloss | None = Field(default=None, alias="unrealizedProfitLoss")
    unrealized_profit_loss_percent: Unrealizedprofitlosspercent | None = Field(default=None, alias="unrealizedProfitLossPercent")
    position_created_at: datetime | None = Field(default=None, alias="positionCreatedAt")
    position_updated_at: datetime | None = Field(default=None, alias="positionUpdatedAt")
    position_closed_at: datetime | None = Field(default=None, alias="positionClosedAt")
    position_group_id: StrictStr | None = Field(default=None, alias="positionGroupId")
    snapshot_date: date | None = Field(default=None, alias="snapshotDate")
    instrument_key: StrictStr | None = Field(default=None, alias="instrumentKey")
