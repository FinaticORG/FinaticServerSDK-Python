...
class FDXBrokerPositionLot(BaseModel):
    ...
    position_id: StrictStr | None = Field(default=None, alias="positionId")
    ...
    close_price_avg: Closepriceavg | None = Field(default=None, alias="closePriceAvg")
    ...
    position_lot_fills: list[FDXBrokerPositionLotFill] | None = Field(default=None, description="Fills associated with this lot", alias="positionLotFills")
