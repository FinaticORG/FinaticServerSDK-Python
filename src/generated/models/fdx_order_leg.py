...
class FDXOrderLeg(BaseModel):
    ...
    side: Side
    quantity: Quantity
    remaining_quantity: Remainingquantity | None = Field(default=None, alias="remainingQuantity")
    limit_price: Limitprice | None = Field(default=None, alias="limitPrice")
    stop_price: Stopprice | None = Field(default=None, alias="stopPrice")
    filled_quantity: Filledquantity | None = Field(default=None, alias="filledQuantity")
    average_fill_price: Averagefillprice | None = Field(default=None, alias="averageFillPrice")
    option_type: StrictStr | None = Field(default=None, alias="optionType")
    strike_price: Strikeprice | None = Field(default=None, alias="strikePrice")
    expiration_date: date | None = Field(default=None, alias="expirationDate")
    underlying_symbol: StrictStr | None = Field(default=None, alias="underlyingSymbol")
    contract_code: StrictStr | None = Field(default=None, alias="contractCode")
    future_underlying_asset_type: Futureunderlyingassettype | None = Field(default=None, alias="futureUnderlyingAssetType")
    crypto_base_symbol: StrictStr | None = Field(default=None, alias="cryptoBaseSymbol")
    crypto_quote_symbol: StrictStr | None = Field(default=None, alias="cryptoQuoteSymbol")
    broker_provided_symbol: StrictStr | None = Field(default=None, alias="brokerProvidedSymbol")
