...
from .success_payload_session_user_response import (
    SuccessPayloadSessionUserResponse,
)


class FinaticBrokerFactoryCoreStandardModelsAbstractResponsesFinaticResponseSessionUserResponse2(BaseModel):
    ...
    success: SuccessPayloadSessionUserResponse | None = None
