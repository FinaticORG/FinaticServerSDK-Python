...
class FinaticError(BaseModel):
    ...
    error: Dict[str, Any] = Field(
        description="Error details including type, code, message, and trace_id. Shape: { type: FinaticErrorType, code: string, message: string, trace_id: string, details?: any, fields?: FinaticErrorField[] }"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"error": obj.get("error"), "meta": obj.get("meta")})
