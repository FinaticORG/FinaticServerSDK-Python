...
from .success_payload_disconnect_company_from_broker_connection_result import (
...
class FinaticResponseDisconnectCompanyFromBrokerConnectionResult(BaseModel):
    ...
    trace_id: StrictStr | None = Field(default='', description="Request trace identifier for tracking and debugging. Auto-generated if not provided.")
    success: SuccessPayloadDisconnectCompanyFromBrokerConnectionResult | None = None
    error: dict[str, Any] | None = None
    warning: list[dict[str, Any]] | None = None
