        ...
        _obj = cls.model_validate(
            {
                ...
                "data": (
                    [OrderEventResponse.from_dict(_item) for _item in obj["data"]]
                    if obj.get("data") is not None
                    else None
                ),
                "response_data": (
                    [
                        OrderEventResponse.from_dict(_item)
                ...
                "status_code": (
                    obj.get("status_code")
                    if obj.get("status_code") is not None
                    else 200
                ),
                "warnings": (
                    [FinaticAPIWarning.from_dict(_item) for _item in obj["warnings"]]
