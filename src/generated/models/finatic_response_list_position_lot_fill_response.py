...
class FinaticResponseListPositionLotFillResponse(BaseModel):
    """
    ...
    data: Optional[List[PositionLotFillResponse]] = None
    response_data: Optional[List[PositionLotFillResponse]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FinaticResponseListPositionLotFillResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FinaticResponseListPositionLotFillResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "data": [PositionLotFillResponse.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "response_data": [PositionLotFillResponse.from_dict(_item) for _item in obj["response_data"]] if obj.get("response_data") is not None else None,
