...
class FinaticResponseListPositionLotResponse(BaseModel):
    """
    FinaticResponseListPositionLotResponse
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, alias="_id")
    success: StrictBool = Field(description="Whether the request was successful")
    data: Optional[List[PositionLotResponse]] = None
    response_data: Optional[List[PositionLotResponse]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FinaticResponseListPositionLotResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FinaticResponseListPositionLotResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "data": [PositionLotResponse.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "response_data": [PositionLotResponse.from_dict(_item) for _item in obj["response_data"]] if obj.get("response_data") is not None else None,
