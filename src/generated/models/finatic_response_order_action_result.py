...
class FinaticResponseOrderActionResult(BaseModel):
    ...
    data: Optional[OrderActionResult] = None
    response_data: Optional[OrderActionResult] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": OrderActionResult.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "response_data": OrderActionResult.from_dict(obj["response_data"]) if obj.get("response_data") is not None else None,
