...
class LegacyBrokerAccount(BaseModel):
    ...
    account_number: StrictStr | None = Field(default=None, alias="accountNumber")
    account_name: StrictStr | None = Field(default=None, alias="accountName")
    account_type: StrictStr | None = Field(default=None, alias="accountType")
    broker_id: StrictStr | None = Field(default=None, alias="brokerId")
    broker_name: StrictStr | None = Field(default=None, alias="brokerName")
    institution_id: StrictStr | None = Field(default=None, alias="institutionId")
    currency_code: StrictStr | None = Field(default=None, alias="currencyCode")
    account_status: StrictStr | None = Field(default=None, alias="accountStatus")
    sub_account_type: StrictStr | None = Field(default=None, alias="subAccountType")
    account_classification: StrictStr | None = Field(default=None, alias="accountClassification")
    ...
    account_created_at: datetime | None = Field(default=None, alias="accountCreatedAt")
    account_updated_at: datetime | None = Field(default=None, alias="accountUpdatedAt")
    account_first_trade_at: datetime | None = Field(default=None, alias="accountFirstTradeAt")
    last_synced_at: datetime | None = Field(default=None, alias="lastSyncedAt")
    balances_synced_at: datetime | None = Field(default=None, alias="balancesSyncedAt")
    orders_synced_at: datetime | None = Field(default=None, alias="ordersSyncedAt")
    positions_synced_at: datetime | None = Field(default=None, alias="positionsSyncedAt")
