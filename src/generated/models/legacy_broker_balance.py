...
class LegacyBrokerBalance(BaseModel):
    ...
    connection_id: StrictStr | None = Field(default=None, alias="connectionId")
    balance_type: StrictStr | None = Field(default=None, alias="balanceType")
    balance_name: StrictStr | None = Field(default=None, alias="balanceName")
    available_balance: Availablebalance | None = Field(default=None, alias="availableBalance")
    current_balance: Currentbalance | None = Field(default=None, alias="currentBalance")
    pending_balance: Pendingbalance | None = Field(default=None, alias="pendingBalance")
    buying_power: Buyingpower | None = Field(default=None, alias="buyingPower")
    cash_balance: Cashbalance | None = Field(default=None, alias="cashBalance")
    net_liquidation_value: Netliquidationvalue | None = Field(default=None, alias="netLiquidationValue")
    initial_margin: Initialmargin | None = Field(default=None, alias="initialMargin")
    maintenance_margin: Maintenancemargin | None = Field(default=None, alias="maintenanceMargin")
    total_cash_value: Totalcashvalue | None = Field(default=None, alias="totalCashValue")
    available_to_withdraw: Availabletowithdraw | None = Field(default=None, alias="availableToWithdraw")
    total_realized_pnl: Totalrealizedpnl | None = Field(default=None, alias="totalRealizedPnl")
    currency_code: StrictStr | None = Field(default=None, alias="currencyCode")
    balance_date: datetime | None = Field(default=None, alias="balanceDate")
