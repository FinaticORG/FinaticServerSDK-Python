...
class NinjaTraderFutureStopOrderPlaceQueryParams(BaseModel):
    ...
    __properties: ClassVar[list[str]] = ["orderType", "assetType", "action", "timeInForce", "symbol", "orderQty", "stopPrice", "accountSpec", "isAutomated", "activationTime", "text", "pegDifference"]
    ...
    def from_json(cls, json_str: str) -> Self | None:
        """Create an instance of NinjaTraderFutureStopOrderPlaceQueryParams from a JSON string"""
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        """Create an instance of NinjaTraderFutureStopOrderPlaceQueryParams from a dict"""
        if obj is None:
            return None
