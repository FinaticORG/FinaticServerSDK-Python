...
class NinjaTraderMarketOrderPlaceQueryParams(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["accountSpec", "isAutomated", "activationTime", "text", "pegDifference", "accountNumber", "orderType", "assetType", "action", "timeInForce", "symbol", "orderQty"]
