...
class NinjaTraderStopOrderPlaceQueryParams(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["accountSpec", "isAutomated", "activationTime", "text", "pegDifference", "orderType", "assetType", "action", "timeInForce", "symbol", "orderQty", "stopPrice"]
