...
class Order(BaseModel):
    ...
    oneof_schema_1_validator: OrderOneOf | None = None
    # data type: OrderOneOf1
    oneof_schema_2_validator: OrderOneOf1 | None = None
    # data type: OrderOneOf2
    oneof_schema_3_validator: OrderOneOf2 | None = None
    actual_instance: OrderOneOf | OrderOneOf1 | OrderOneOf2 | None = None
    ...
    def to_dict(self) -> dict[str, Any] | OrderOneOf | OrderOneOf1 | OrderOneOf2 | None:
