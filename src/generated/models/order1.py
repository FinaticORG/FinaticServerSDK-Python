...
from .ninja_trader_future_limit_order_place_query_params import (
    NinjaTraderFutureLimitOrderPlaceQueryParams,
)
from .ninja_trader_future_market_order_place_query_params import (
    NinjaTraderFutureMarketOrderPlaceQueryParams,
)
from .ninja_trader_future_stop_limit_order_place_query_params import (
    NinjaTraderFutureStopLimitOrderPlaceQueryParams,
)
from .ninja_trader_future_stop_order_place_query_params import (
    NinjaTraderFutureStopOrderPlaceQueryParams,
)
from .ninja_trader_future_trailing_stop_order_place_query_params import (
...
class Order1(BaseModel):
    ...
    oneof_schema_1_validator: NinjaTraderFutureMarketOrderPlaceQueryParams | None = None
    # data type: NinjaTraderFutureLimitOrderPlaceQueryParams
    oneof_schema_2_validator: NinjaTraderFutureLimitOrderPlaceQueryParams | None = None
    # data type: NinjaTraderFutureStopOrderPlaceQueryParams
    oneof_schema_3_validator: NinjaTraderFutureStopOrderPlaceQueryParams | None = None
    # data type: NinjaTraderFutureStopLimitOrderPlaceQueryParams
    oneof_schema_4_validator: NinjaTraderFutureStopLimitOrderPlaceQueryParams | None = None
    # data type: NinjaTraderFutureTrailingStopOrderPlaceQueryParams
    oneof_schema_5_validator: NinjaTraderFutureTrailingStopOrderPlaceQueryParams | None = None
    actual_instance: NinjaTraderFutureLimitOrderPlaceQueryParams | NinjaTraderFutureMarketOrderPlaceQueryParams | NinjaTraderFutureStopLimitOrderPlaceQueryParams | NinjaTraderFutureStopOrderPlaceQueryParams | NinjaTraderFutureTrailingStopOrderPlaceQueryParams | None = None
    ...
    def to_dict(self) -> dict[str, Any] | NinjaTraderFutureLimitOrderPlaceQueryParams | NinjaTraderFutureMarketOrderPlaceQueryParams | NinjaTraderFutureStopLimitOrderPlaceQueryParams | NinjaTraderFutureStopOrderPlaceQueryParams | NinjaTraderFutureTrailingStopOrderPlaceQueryParams | None:
