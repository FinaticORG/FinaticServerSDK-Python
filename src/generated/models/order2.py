...
class Order2(BaseModel):
    ...
    oneof_schema_1_validator: Order2OneOf | None = None
    # data type: Order2OneOf1
    oneof_schema_2_validator: Order2OneOf1 | None = None
    # data type: Order2OneOf2
    oneof_schema_3_validator: Order2OneOf2 | None = None
    actual_instance: Order2OneOf | Order2OneOf1 | Order2OneOf2 | None = None
    ...
    def to_dict(self) -> dict[str, Any] | Order2OneOf | Order2OneOf1 | Order2OneOf2 | None:
