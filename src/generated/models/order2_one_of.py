...
from .robinhood_equity_limit_order_place_query_params import (
    RobinhoodEquityLimitOrderPlaceQueryParams,
)
from .robinhood_equity_market_order_place_query_params import (
    RobinhoodEquityMarketOrderPlaceQueryParams,
)
from .robinhood_equity_stop_limit_order_place_query_params import (
    RobinhoodEquityStopLimitOrderPlaceQueryParams,
)
from .robinhood_equity_stop_order_place_query_params import (
    RobinhoodEquityStopOrderPlaceQueryParams,
)
from .robinhood_equity_trailing_stop_order_place_query_params import (
...
class Order2OneOf(BaseModel):
    ...
    oneof_schema_1_validator: RobinhoodEquityMarketOrderPlaceQueryParams | None = None
    # data type: RobinhoodEquityLimitOrderPlaceQueryParams
    oneof_schema_2_validator: RobinhoodEquityLimitOrderPlaceQueryParams | None = None
    # data type: RobinhoodEquityStopOrderPlaceQueryParams
    oneof_schema_3_validator: RobinhoodEquityStopOrderPlaceQueryParams | None = None
    # data type: RobinhoodEquityStopLimitOrderPlaceQueryParams
    oneof_schema_4_validator: RobinhoodEquityStopLimitOrderPlaceQueryParams | None = None
    # data type: RobinhoodEquityTrailingStopOrderPlaceQueryParams
    oneof_schema_5_validator: RobinhoodEquityTrailingStopOrderPlaceQueryParams | None = None
    actual_instance: RobinhoodEquityLimitOrderPlaceQueryParams | RobinhoodEquityMarketOrderPlaceQueryParams | RobinhoodEquityStopLimitOrderPlaceQueryParams | RobinhoodEquityStopOrderPlaceQueryParams | RobinhoodEquityTrailingStopOrderPlaceQueryParams | None = None
    ...
    def to_dict(self) -> dict[str, Any] | RobinhoodEquityLimitOrderPlaceQueryParams | RobinhoodEquityMarketOrderPlaceQueryParams | RobinhoodEquityStopLimitOrderPlaceQueryParams | RobinhoodEquityStopOrderPlaceQueryParams | RobinhoodEquityTrailingStopOrderPlaceQueryParams | None:
