...
from .robinhood_option_limit_order_place_query_params import (
    RobinhoodOptionLimitOrderPlaceQueryParams,
)
from .robinhood_option_market_order_place_query_params import (
    RobinhoodOptionMarketOrderPlaceQueryParams,
)
from .robinhood_option_stop_limit_order_place_query_params import (
    RobinhoodOptionStopLimitOrderPlaceQueryParams,
)
from .robinhood_option_stop_order_place_query_params import (
    RobinhoodOptionStopOrderPlaceQueryParams,
)
from .robinhood_option_trailing_stop_order_place_query_params import (
    RobinhoodOptionTrailingStopOrderPlaceQueryParams,
)

ORDER2ONEOF1_ONE_OF_SCHEMAS = ["RobinhoodOptionLimitOrderPlaceQueryParams", "RobinhoodOptionMarketOrderPlaceQueryParams", "RobinhoodOptionStopLimitOrderPlaceQueryParams", "RobinhoodOptionStopOrderPlaceQueryParams", "RobinhoodOptionTrailingStopOrderPlaceQueryParams"]

class Order2OneOf1(BaseModel):
    """Order2OneOf1
    """

    # data type: RobinhoodOptionMarketOrderPlaceQueryParams
    oneof_schema_1_validator: RobinhoodOptionMarketOrderPlaceQueryParams | None = None
    # data type: RobinhoodOptionLimitOrderPlaceQueryParams
    oneof_schema_2_validator: RobinhoodOptionLimitOrderPlaceQueryParams | None = None
    # data type: RobinhoodOptionStopOrderPlaceQueryParams
    oneof_schema_3_validator: RobinhoodOptionStopOrderPlaceQueryParams | None = None
    # data type: RobinhoodOptionStopLimitOrderPlaceQueryParams
    oneof_schema_4_validator: RobinhoodOptionStopLimitOrderPlaceQueryParams | None = None
    # data type: RobinhoodOptionTrailingStopOrderPlaceQueryParams
    oneof_schema_5_validator: RobinhoodOptionTrailingStopOrderPlaceQueryParams | None = None
    actual_instance: RobinhoodOptionLimitOrderPlaceQueryParams | RobinhoodOptionMarketOrderPlaceQueryParams | RobinhoodOptionStopLimitOrderPlaceQueryParams | RobinhoodOptionStopOrderPlaceQueryParams | RobinhoodOptionTrailingStopOrderPlaceQueryParams | None = None
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = Order2OneOf1.model_construct()
        error_messages = []
        match = 0
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in Order2OneOf1 with oneOf schemas: RobinhoodOptionLimitOrderPlaceQueryParams, RobinhoodOptionMarketOrderPlaceQueryParams, RobinhoodOptionStopLimitOrderPlaceQueryParams, RobinhoodOptionStopOrderPlaceQueryParams, RobinhoodOptionTrailingStopOrderPlaceQueryParams. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in Order2OneOf1 with oneOf schemas: RobinhoodOptionLimitOrderPlaceQueryParams, RobinhoodOptionMarketOrderPlaceQueryParams, RobinhoodOptionStopLimitOrderPlaceQueryParams, RobinhoodOptionStopOrderPlaceQueryParams, RobinhoodOptionTrailingStopOrderPlaceQueryParams. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into Order2OneOf1 with oneOf schemas: RobinhoodOptionLimitOrderPlaceQueryParams, RobinhoodOptionMarketOrderPlaceQueryParams, RobinhoodOptionStopLimitOrderPlaceQueryParams, RobinhoodOptionStopOrderPlaceQueryParams, RobinhoodOptionTrailingStopOrderPlaceQueryParams. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
    ...
    def to_dict(self) -> dict[str, Any] | RobinhoodOptionLimitOrderPlaceQueryParams | RobinhoodOptionMarketOrderPlaceQueryParams | RobinhoodOptionStopLimitOrderPlaceQueryParams | RobinhoodOptionStopOrderPlaceQueryParams | RobinhoodOptionTrailingStopOrderPlaceQueryParams | None:
