...
class Order3(BaseModel):
    ...
    oneof_schema_1_validator: Order3OneOf | None = None
    # data type: Order3OneOf1
    oneof_schema_2_validator: Order3OneOf1 | None = None
    actual_instance: Order3OneOf | Order3OneOf1 | None = None
    ...
    def to_dict(self) -> dict[str, Any] | Order3OneOf | Order3OneOf1 | None:
