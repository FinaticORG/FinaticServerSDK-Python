...
from .webull_limit_order_modify_query_params import (
    WebullLimitOrderModifyQueryParams,
)
from .webull_market_order_modify_query_params import (
    WebullMarketOrderModifyQueryParams,
)
from .webull_stop_order_modify_query_params import (
    WebullStopOrderModifyQueryParams,
)
from .webull_trailing_stop_order_modify_query_params import (
    WebullTrailingStopOrderModifyQueryParams,
)

ORDER7_ONE_OF_SCHEMAS = ["WebullLimitOrderModifyQueryParams", "WebullMarketOrderModifyQueryParams", "WebullStopOrderModifyQueryParams", "WebullTrailingStopOrderModifyQueryParams"]
...
class Order7(BaseModel):
    ...
    oneof_schema_1_validator: WebullMarketOrderModifyQueryParams | None = None
    # data type: WebullLimitOrderModifyQueryParams
    oneof_schema_2_validator: WebullLimitOrderModifyQueryParams | None = None
    # data type: WebullStopOrderModifyQueryParams
    oneof_schema_3_validator: WebullStopOrderModifyQueryParams | None = None
    # data type: WebullTrailingStopOrderModifyQueryParams
    oneof_schema_4_validator: WebullTrailingStopOrderModifyQueryParams | None = None
    actual_instance: WebullLimitOrderModifyQueryParams | WebullMarketOrderModifyQueryParams | WebullStopOrderModifyQueryParams | WebullTrailingStopOrderModifyQueryParams | None = None
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in Order7 with oneOf schemas: WebullLimitOrderModifyQueryParams, WebullMarketOrderModifyQueryParams, WebullStopOrderModifyQueryParams, WebullTrailingStopOrderModifyQueryParams. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in Order7 with oneOf schemas: WebullLimitOrderModifyQueryParams, WebullMarketOrderModifyQueryParams, WebullStopOrderModifyQueryParams, WebullTrailingStopOrderModifyQueryParams. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into Order7 with oneOf schemas: WebullLimitOrderModifyQueryParams, WebullMarketOrderModifyQueryParams, WebullStopOrderModifyQueryParams, WebullTrailingStopOrderModifyQueryParams. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when deserializing the JSON string into Order7 with oneOf schemas: WebullLimitOrderModifyQueryParams, WebullMarketOrderModifyQueryParams, WebullStopOrderModifyQueryParams, WebullTrailingStopOrderModifyQueryParams. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> dict[str, Any] | WebullLimitOrderModifyQueryParams | WebullMarketOrderModifyQueryParams | WebullStopOrderModifyQueryParams | WebullTrailingStopOrderModifyQueryParams | None:
