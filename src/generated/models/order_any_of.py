...
ORDERANYOF_ONE_OF_SCHEMAS = ["RobinhoodEquityLimitOrderPlaceQueryParams", "RobinhoodEquityMarketOrderPlaceQueryParams", "RobinhoodEquityStopLimitOrderPlaceQueryParams", "RobinhoodEquityStopOrderPlaceQueryParams", "RobinhoodEquityTrailingStopOrderPlaceQueryParams"]

class OrderAnyOf(BaseModel):
    """
    OrderAnyOf
    """
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = OrderAnyOf.model_construct()
        error_messages = []
        match = 0
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in OrderAnyOf with oneOf schemas: RobinhoodEquityLimitOrderPlaceQueryParams, RobinhoodEquityMarketOrderPlaceQueryParams, RobinhoodEquityStopLimitOrderPlaceQueryParams, RobinhoodEquityStopOrderPlaceQueryParams, RobinhoodEquityTrailingStopOrderPlaceQueryParams. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in OrderAnyOf with oneOf schemas: RobinhoodEquityLimitOrderPlaceQueryParams, RobinhoodEquityMarketOrderPlaceQueryParams, RobinhoodEquityStopLimitOrderPlaceQueryParams, RobinhoodEquityStopOrderPlaceQueryParams, RobinhoodEquityTrailingStopOrderPlaceQueryParams. Details: " + ", ".join(error_messages))
        else:
            return v
