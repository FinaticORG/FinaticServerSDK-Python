...
class OrderEventResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "order_id", "event_type", "timestamp", "details"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrderEventResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrderEventResponse from a dict"""
        if obj is None:
            return None
