...
PLACEORDERAPIBETABROKERSORDERSPOSTREQUEST_ONE_OF_SCHEMAS = ["AlpacaOrderPlaceRequest", "NinjaTraderOrderPlaceRequest", "RobinhoodOrderPlaceRequest", "TastyTradeOrderPlaceRequest", "TradestationOrderPlaceRequest", "Trading212OrderPlaceRequest", "WebullOrderPlaceRequest"]
...
class PlaceOrderApiBetaBrokersOrdersPostRequest(BaseModel):
    ...
    oneof_schema_1_validator: AlpacaOrderPlaceRequest | None = None
    # data type: NinjaTraderOrderPlaceRequest
    oneof_schema_2_validator: NinjaTraderOrderPlaceRequest | None = None
    # data type: RobinhoodOrderPlaceRequest
    oneof_schema_3_validator: RobinhoodOrderPlaceRequest | None = None
    # data type: TastyTradeOrderPlaceRequest
    oneof_schema_4_validator: TastyTradeOrderPlaceRequest | None = None
    # data type: TradestationOrderPlaceRequest
    oneof_schema_5_validator: TradestationOrderPlaceRequest | None = None
    # data type: Trading212OrderPlaceRequest
    oneof_schema_6_validator: Trading212OrderPlaceRequest | None = None
    # data type: WebullOrderPlaceRequest
    oneof_schema_7_validator: WebullOrderPlaceRequest | None = None
    actual_instance: AlpacaOrderPlaceRequest | NinjaTraderOrderPlaceRequest | RobinhoodOrderPlaceRequest | TastyTradeOrderPlaceRequest | TradestationOrderPlaceRequest | Trading212OrderPlaceRequest | WebullOrderPlaceRequest | None = None
    one_of_schemas: set[str] = { "AlpacaOrderPlaceRequest", "NinjaTraderOrderPlaceRequest", "RobinhoodOrderPlaceRequest", "TastyTradeOrderPlaceRequest", "TradestationOrderPlaceRequest", "Trading212OrderPlaceRequest", "WebullOrderPlaceRequest" }
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in PlaceOrderApiBetaBrokersOrdersPostRequest with oneOf schemas: AlpacaOrderPlaceRequest, NinjaTraderOrderPlaceRequest, RobinhoodOrderPlaceRequest, TastyTradeOrderPlaceRequest, TradestationOrderPlaceRequest, Trading212OrderPlaceRequest, WebullOrderPlaceRequest. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
    ...
    def to_dict(self) -> dict[str, Any] | AlpacaOrderPlaceRequest | NinjaTraderOrderPlaceRequest | RobinhoodOrderPlaceRequest | TastyTradeOrderPlaceRequest | TradestationOrderPlaceRequest | Trading212OrderPlaceRequest | WebullOrderPlaceRequest | None:
