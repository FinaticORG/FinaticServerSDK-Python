...
class RobinhoodEquityTrailingStopOrderPlaceQueryParams(BaseModel):
    ...
    extended_hours: StrictBool | None = Field(default=False, description="Allow trading during extended hours (premium users only)", alias="extendedHours")
    market_hours: StrictStr | None = Field(default='regular_hours', description="Market hours to trade in", alias="marketHours")
