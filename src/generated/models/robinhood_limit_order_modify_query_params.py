...
class RobinhoodLimitOrderModifyQueryParams(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["extendedHours", "marketHours", "direction", "spread", "positionEffect", "creditOrDebit", "expirationDate", "strike", "optionType", "amountIn", "orderId", "orderType", "assetType", "timeInForce", "isAutomated", "price"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RobinhoodLimitOrderModifyQueryParams from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RobinhoodLimitOrderModifyQueryParams from a dict"""
        if obj is None:
            return None
