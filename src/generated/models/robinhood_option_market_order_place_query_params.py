...
class RobinhoodOptionMarketOrderPlaceQueryParams(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["accountNumber", "orderType", "assetType", "action", "timeInForce", "symbol", "orderQty", "direction", "spread", "positionEffect", "creditOrDebit", "expirationDate", "strikePrice", "optionType"]
