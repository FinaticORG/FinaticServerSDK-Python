...
class RobinhoodOptionStopLimitOrderPlaceQueryParams(BaseModel):
    ...
    spread: list[RobinhoodOptionSpreadLeg] | None = None
    ...
    expiration_date: StrictStr | None = Field(default=None, alias="expirationDate")
    strike_price: StrictFloat | StrictInt | None = Field(default=None, alias="strikePrice")
    option_type: StrictStr | None = Field(default=None, alias="optionType")
