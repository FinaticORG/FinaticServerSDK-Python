...
class TastyTradeLimitOrderPlaceQueryParams(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["automated-source", "price-effect", "external-identifier", "partition-key", "preflight-id", "source", "value-effect", "legs", "accountNumber", "orderType", "assetType", "action", "timeInForce", "symbol", "orderQty", "price"]
