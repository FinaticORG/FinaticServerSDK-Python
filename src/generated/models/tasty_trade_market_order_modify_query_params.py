...
class TastyTradeMarketOrderModifyQueryParams(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["accountNumber", "automated-source", "external-identifier", "partition-key", "preflight-id", "source", "orderId", "orderType", "assetType", "timeInForce", "isAutomated"]
