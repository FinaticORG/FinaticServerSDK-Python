...
class TastyTradeOptionMarketOrderPlaceQueryParams(BaseModel):
    ...
    __properties: ClassVar[list[str]] = ["orderType", "assetType", "action", "timeInForce", "symbol", "orderQty", "automated-source", "price-effect", "external-identifier", "partition-key", "preflight-id", "source", "value-effect", "expirationDate", "strikePrice", "optionType", "positionEffect"]
    ...
    def from_json(cls, json_str: str) -> Self | None:
        """Create an instance of TastyTradeOptionMarketOrderPlaceQueryParams from a JSON string"""
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        """Create an instance of TastyTradeOptionMarketOrderPlaceQueryParams from a dict"""
        if obj is None:
            return None
