...
class TastyTradeOrderCancelQueryParams(BaseModel):
    ...
    account_number: StrictInt = Field(
        description="TastyTrade account number owning the order.", alias="accountNumber"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"orderId": obj.get("orderId"), "accountNumber": obj.get("accountNumber")}
        )
