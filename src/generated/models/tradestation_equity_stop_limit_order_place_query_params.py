...
class TradestationEquityStopLimitOrderPlaceQueryParams(BaseModel):
    ...
    __properties: ClassVar[list[str]] = ["orderType", "assetType", "action", "timeInForce", "symbol", "orderQty", "stopPrice", "limitPrice", "accountId"]
    ...
    def from_json(cls, json_str: str) -> Self | None:
        """Create an instance of TradestationEquityStopLimitOrderPlaceQueryParams from a JSON string"""
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        """Create an instance of TradestationEquityStopLimitOrderPlaceQueryParams from a dict"""
        if obj is None:
            return None
