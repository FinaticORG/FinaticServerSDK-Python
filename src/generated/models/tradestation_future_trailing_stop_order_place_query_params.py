...
class TradestationFutureTrailingStopOrderPlaceQueryParams(BaseModel):
    ...
    __properties: ClassVar[list[str]] = ["orderType", "assetType", "action", "timeInForce", "symbol", "orderQty", "stopPrice", "trailPercent", "trailPrice", "accountId", "route"]
    ...
    def from_json(cls, json_str: str) -> Self | None:
        """Create an instance of TradestationFutureTrailingStopOrderPlaceQueryParams from a JSON string"""
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        """Create an instance of TradestationFutureTrailingStopOrderPlaceQueryParams from a dict"""
        if obj is None:
            return None
