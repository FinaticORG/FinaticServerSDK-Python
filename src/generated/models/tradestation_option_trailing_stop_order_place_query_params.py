...
class TradestationOptionTrailingStopOrderPlaceQueryParams(BaseModel):
    ...
    option_route_kind: StrictStr | None = Field(default=None, alias="optionRouteKind")
    additional_properties: dict[str, Any] = {}
    __properties: ClassVar[list[str]] = ["orderType", "assetType", "action", "timeInForce", "symbol", "orderQty", "stopPrice", "trailPercent", "trailPrice", "accountId", "route", "optionRouteKind"]
