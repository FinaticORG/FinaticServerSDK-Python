...
class WebullOptionStopOrderPlaceQueryParams(BaseModel):
    ...
    position_effect: StrictStr | None = Field(default=None, alias="positionEffect")
    credit_or_debit: StrictStr | None = Field(default=None, alias="creditOrDebit")
    additional_properties: dict[str, Any] = {}
    __properties: ClassVar[list[str]] = ["orderType", "assetType", "action", "timeInForce", "symbol", "orderQty", "stopPrice", "supportTradingSession", "clientOrderId", "expirationDate", "strikePrice", "optionType", "positionEffect", "creditOrDebit"]
