...
async def apply_request_interceptors(
    config: Dict[str, Any], sdk_config: Optional[SdkConfig] = None
) -> Dict[str, Any]:
...
async def apply_response_interceptors(
    response: Any, sdk_config: Optional[SdkConfig] = None
) -> Any:
...
async def apply_error_interceptors(
    error: Exception, sdk_config: Optional[SdkConfig] = None
) -> Exception:
