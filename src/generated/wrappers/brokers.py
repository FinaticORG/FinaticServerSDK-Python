...
class ListBrokerConnectionsResponse:
    ...
    success: Dict[str, Any]  # {"data": list[UserBrokerConnections], "meta"?: Dict[str, Any]}
    Error: Optional[Dict[str, Any]] = None  # {"message": str, "code"?: str, "details"?: Dict[str, Any]}
    Warning: Optional[List[Dict[str, Any]]] = None  # [{"message": str, "code"?: str, "details"?: Dict[str, Any]}]
...
class GetOrderFillsResponse:
    ...
    success: Dict[str, Any]  # {"data": list[OrderFillResponse], "meta"?: Dict[str, Any]}
    Error: Optional[Dict[str, Any]] = None  # {"message": str, "code"?: str, "details"?: Dict[str, Any]}
    Warning: Optional[List[Dict[str, Any]]] = None  # [{"message": str, "code"?: str, "details"?: Dict[str, Any]}]
...
class GetOrderEventsResponse:
    ...
    success: Dict[str, Any]  # {"data": list[OrderEventResponse], "meta"?: Dict[str, Any]}
    Error: Optional[Dict[str, Any]] = None  # {"message": str, "code"?: str, "details"?: Dict[str, Any]}
    Warning: Optional[List[Dict[str, Any]]] = None  # [{"message": str, "code"?: str, "details"?: Dict[str, Any]}]
...
class GetOrderGroupsResponse:
    ...
    success: Dict[str, Any]  # {"data": list[OrderGroupResponse], "meta"?: Dict[str, Any]}
    Error: Optional[Dict[str, Any]] = None  # {"message": str, "code"?: str, "details"?: Dict[str, Any]}
    Warning: Optional[List[Dict[str, Any]]] = None  # [{"message": str, "code"?: str, "details"?: Dict[str, Any]}]
...
class GetPositionLotsResponse:
    ...
    success: Dict[str, Any]  # {"data": list[PositionLotResponse], "meta"?: Dict[str, Any]}
    Error: Optional[Dict[str, Any]] = None  # {"message": str, "code"?: str, "details"?: Dict[str, Any]}
    Warning: Optional[List[Dict[str, Any]]] = None  # [{"message": str, "code"?: str, "details"?: Dict[str, Any]}]
...
class GetPositionLotFillsResponse:
    ...
    success: Dict[str, Any]  # {"data": list[PositionLotFillResponse], "meta"?: Dict[str, Any]}
    Error: Optional[Dict[str, Any]] = None  # {"message": str, "code"?: str, "details"?: Dict[str, Any]}
    Warning: Optional[List[Dict[str, Any]]] = None  # [{"message": str, "code"?: str, "details"?: Dict[str, Any]}]
...
class BrokersWrapper:
    ...
    async def place_order(self, params: PlaceOrderParams) -> PlaceOrderResponse:
        ...
        # Phase 2C: Extract individual params from input params object
        place_order_api_v1_brokers_orders_post_request = getattr(params, 'place_order_api_v1_brokers_orders_post_request', None)
        connection_id = getattr(params, 'connection_id', None)
        ...
        try:
            async def api_call():
                ...
                if self.csrf_token:
                    headers["x-csrf-token"] = self.csrf_token
                response = await self.api.place_order_api_v1_brokers_orders_post(connection_id=connection_id, place_order_api_v1_brokers_orders_post_request=place_order_api_v1_brokers_orders_post_request, _headers=headers)
    ...
    async def cancel_order(self, params: CancelOrderParams) -> CancelOrderResponse:
        ...
        # Phase 2C: Extract individual params from input params object
        order_id = params.order_id
        cancel_order_api_v1_brokers_orders_order_id_delete_request = getattr(params, 'cancel_order_api_v1_brokers_orders_order_id_delete_request', None)
        ...
        try:
            async def api_call():
                ...
                if self.csrf_token:
                    headers["x-csrf-token"] = self.csrf_token
                response = await self.api.cancel_order_api_v1_brokers_orders_order_id_delete(order_id=order_id, account_number=account_number, connection_id=connection_id, cancel_order_api_v1_brokers_orders_order_id_delete_request=cancel_order_api_v1_brokers_orders_order_id_delete_request, _headers=headers)
    ...
    async def modify_order(self, params: ModifyOrderParams) -> ModifyOrderResponse:
        ...
        # Phase 2C: Extract individual params from input params object
        order_id = params.order_id
        modify_order_api_v1_brokers_orders_order_id_patch_request = getattr(params, 'modify_order_api_v1_brokers_orders_order_id_patch_request', None)
        account_number = getattr(params, 'account_number', None)
        connection_id = getattr(params, 'connection_id', None)
        ...
        try:
            async def api_call():
                ...
                if self.csrf_token:
                    headers["x-csrf-token"] = self.csrf_token
                response = await self.api.modify_order_api_v1_brokers_orders_order_id_patch(order_id=order_id, account_number=account_number, connection_id=connection_id, modify_order_api_v1_brokers_orders_order_id_patch_request=modify_order_api_v1_brokers_orders_order_id_patch_request, _headers=headers)
