...
class MarketDataWrapper:
    ...
    def __init__(self, api: MarketDataApi, config: Optional[Configuration] = None, sdk_config: Optional[SdkConfig] = None):
        self.api = api
        self.config = config
    ...
    async def get_futures_historical(self, symbol: str, start_date: Any = None, end_date: Any = None, expiration: Any = None, provider: Any = None) -> list:
        ...
        self.logger.debug('Get Futures Historical',
        ...
        try:
            ...
            self.logger.error('Get Futures Historical failed',
                error=str(e),
                request_id=request_id,
                action='get_futures_historical',
                exc_info=True
