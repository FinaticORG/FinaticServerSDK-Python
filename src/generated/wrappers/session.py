...
class SessionWrapper:
    ...
    async def start_session(self, one_time_token: str, session_start_request: SessionStartRequest) -> SessionResponseData:
        """Start Session
    ...
    async def authenticate_session(self, direct_auth_request: DirectAuthRequest) -> TokenData:
    ...
    async def refresh_session(self, session_id: str, company_id: str) -> SessionResponseData:
        """Refresh Session
    ...
    async def test_webhook(self, finaticapi_api_v1_routers_session_session_router_test_webhook_request: FinaticapiApiV1RoutersSessionSessionRouterTestWebhookRequest) -> TestWebhookResponse:
        """Test Webhook
    ...
    async def link_user_to_session(self, session_id: str, session_link_request: SessionLinkRequest) -> Any:
        ...
        # Structured logging (Phase 2B: structlog)
        self.logger.debug('Link User To Session',
            request_id=request_id,
            method='POST',
        ...
        try:
            ...
            self.logger.error('Link User To Session failed',
                error=str(e),
                request_id=request_id,
                action='link_user_to_session',
                exc_info=True
