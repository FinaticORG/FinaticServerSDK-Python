...
from finatic_server_legacy.models.notional import Notional
...
class AlpacaOptionLimitOrderPlaceQueryParams(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["action", "assetType", "client_order_id", "extended_hours", "legs", "notional", "orderQty", "orderType", "order_class", "price", "stop_loss", "symbol", "take_profit", "timeInForce"]
