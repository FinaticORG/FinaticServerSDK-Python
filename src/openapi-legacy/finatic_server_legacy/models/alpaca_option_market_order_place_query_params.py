...
class AlpacaOptionMarketOrderPlaceQueryParams(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["action", "assetType", "client_order_id", "extended_hours", "legs", "notional", "orderQty", "orderType", "order_class", "stop_loss", "symbol", "take_profit", "timeInForce"]
