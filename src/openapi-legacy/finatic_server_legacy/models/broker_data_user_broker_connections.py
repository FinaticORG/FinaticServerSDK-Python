...
from finatic_server_legacy.models.broker_data_connection_status_enum import BrokerDataConnectionStatusEnum
from typing import Optional, Set
from typing_extensions import Self
from pydantic_core import to_jsonable_python

class BrokerDataUserBrokerConnections(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BrokerDataUserBrokerConnections from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BrokerDataUserBrokerConnections from a dict"""
        if obj is None:
            return None
