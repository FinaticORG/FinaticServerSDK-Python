...
class FinaticBrokerFactoryCoreStandardModelsAbstractResponsesFinaticResponseSessionResponseData1(BaseModel):
    """
    ...
    success: Optional[SuccessPayloadSessionResponseData] = Field(default=None, description="Success payload containing data and optional meta. None when error is present.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FinaticBrokerFactoryCoreStandardModelsAbstractResponsesFinaticResponseSessionResponseData1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FinaticBrokerFactoryCoreStandardModelsAbstractResponsesFinaticResponseSessionResponseData1 from a dict"""
        if obj is None:
            return None
