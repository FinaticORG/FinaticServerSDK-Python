...
class FinaticResponseFDXConsentGrant(BaseModel):
    """
    ...
    success: Optional[SuccessPayloadFDXConsentGrant] = Field(default=None, description="Success payload containing data and optional meta. None when error is present.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FinaticResponseFDXConsentGrant from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FinaticResponseFDXConsentGrant from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "error": obj.get("error"),
            "success": SuccessPayloadFDXConsentGrant.from_dict(obj["success"]) if obj.get("success") is not None else None,
