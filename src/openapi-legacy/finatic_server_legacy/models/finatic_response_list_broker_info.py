...
from finatic_server_legacy.models.success_payload_list_broker_info import SuccessPayloadListBrokerInfo
...
class FinaticResponseListBrokerInfo(BaseModel):
    ...
    success: Optional[SuccessPayloadListBrokerInfo] = Field(default=None, description="Success payload containing data and optional meta. None when error is present.")
