...
class FinaticResponseListFDXBrokerAccount(BaseModel):
    ...
    success: Optional[SuccessPayloadListFDXBrokerAccount] = Field(default=None, description="Success payload containing data and optional meta. None when error is present.")
