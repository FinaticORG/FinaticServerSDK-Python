...
class FinaticResponseListFDXBrokerBalance(BaseModel):
    ...
    success: Optional[SuccessPayloadListFDXBrokerBalance] = Field(default=None, description="Success payload containing data and optional meta. None when error is present.")
