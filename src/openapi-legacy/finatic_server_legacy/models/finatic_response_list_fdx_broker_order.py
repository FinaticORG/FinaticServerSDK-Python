...
from finatic_server_legacy.models.success_payload_list_fdx_broker_order import SuccessPayloadListFDXBrokerOrder
...
class FinaticResponseListFDXBrokerOrder(BaseModel):
    ...
    success: Optional[SuccessPayloadListFDXBrokerOrder] = Field(default=None, description="Success payload containing data and optional meta. None when error is present.")
