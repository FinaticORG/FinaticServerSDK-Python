...
from finatic_server_legacy.models.success_payload_list_fdx_broker_order_event import SuccessPayloadListFDXBrokerOrderEvent
...
class FinaticResponseListFDXBrokerOrderEvent(BaseModel):
    ...
    success: Optional[SuccessPayloadListFDXBrokerOrderEvent] = Field(default=None, description="Success payload containing data and optional meta. None when error is present.")
