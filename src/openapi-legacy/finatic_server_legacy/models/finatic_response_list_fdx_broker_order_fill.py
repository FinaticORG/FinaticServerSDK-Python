...
from finatic_server_legacy.models.success_payload_list_fdx_broker_order_fill import SuccessPayloadListFDXBrokerOrderFill
...
class FinaticResponseListFDXBrokerOrderFill(BaseModel):
    ...
    success: Optional[SuccessPayloadListFDXBrokerOrderFill] = Field(default=None, description="Success payload containing data and optional meta. None when error is present.")
