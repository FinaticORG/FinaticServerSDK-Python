...
from finatic_server_legacy.models.success_payload_list_fdx_broker_position import SuccessPayloadListFDXBrokerPosition
...
class FinaticResponseListFDXBrokerPosition(BaseModel):
    ...
    success: Optional[SuccessPayloadListFDXBrokerPosition] = Field(default=None, description="Success payload containing data and optional meta. None when error is present.")
