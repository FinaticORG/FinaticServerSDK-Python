...
from finatic_server_legacy.models.success_payload_list_fdx_broker_position_lot import SuccessPayloadListFDXBrokerPositionLot
...
class FinaticResponseListFDXBrokerPositionLot(BaseModel):
    ...
    success: Optional[SuccessPayloadListFDXBrokerPositionLot] = Field(default=None, description="Success payload containing data and optional meta. None when error is present.")
