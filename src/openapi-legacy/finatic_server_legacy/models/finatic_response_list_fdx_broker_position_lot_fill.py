...
from finatic_server_legacy.models.success_payload_list_fdx_broker_position_lot_fill import SuccessPayloadListFDXBrokerPositionLotFill
...
class FinaticResponseListFDXBrokerPositionLotFill(BaseModel):
    ...
    success: Optional[SuccessPayloadListFDXBrokerPositionLotFill] = Field(default=None, description="Success payload containing data and optional meta. None when error is present.")
