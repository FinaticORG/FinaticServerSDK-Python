...
from finatic_server_legacy.models.success_payload_list_fdx_broker_transaction import SuccessPayloadListFDXBrokerTransaction
from typing import Optional, Set
from typing_extensions import Self
from pydantic_core import to_jsonable_python

class FinaticResponseListFDXBrokerTransaction(BaseModel):
    """
    ...
    success: Optional[SuccessPayloadListFDXBrokerTransaction] = Field(default=None, description="Success payload containing data and optional meta. None when error is present.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FinaticResponseListFDXBrokerTransaction from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FinaticResponseListFDXBrokerTransaction from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "error": obj.get("error"),
            "success": SuccessPayloadListFDXBrokerTransaction.from_dict(obj["success"]) if obj.get("success") is not None else None,
