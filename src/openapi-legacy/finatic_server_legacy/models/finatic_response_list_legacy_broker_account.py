...
from finatic_server_legacy.models.success_payload_list_legacy_broker_account import SuccessPayloadListLegacyBrokerAccount
...
class FinaticResponseListLegacyBrokerAccount(BaseModel):
    ...
    success: Optional[SuccessPayloadListLegacyBrokerAccount] = Field(default=None, description="Success payload containing data and optional meta. None when error is present.")
