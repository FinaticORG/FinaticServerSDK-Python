...
from finatic_server_legacy.models.success_payload_list_legacy_broker_balance import SuccessPayloadListLegacyBrokerBalance
...
class FinaticResponseListLegacyBrokerBalance(BaseModel):
    ...
    success: Optional[SuccessPayloadListLegacyBrokerBalance] = Field(default=None, description="Success payload containing data and optional meta. None when error is present.")
