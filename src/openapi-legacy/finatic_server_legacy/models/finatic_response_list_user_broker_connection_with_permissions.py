...
from finatic_server_legacy.models.success_payload_list_user_broker_connection_with_permissions import SuccessPayloadListUserBrokerConnectionWithPermissions
...
class FinaticResponseListUserBrokerConnectionWithPermissions(BaseModel):
    ...
    success: Optional[SuccessPayloadListUserBrokerConnectionWithPermissions] = Field(default=None, description="Success payload containing data and optional meta. None when error is present.")
