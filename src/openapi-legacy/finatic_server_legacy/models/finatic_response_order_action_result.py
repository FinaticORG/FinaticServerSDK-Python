...
from finatic_server_legacy.models.success_payload_order_action_result import SuccessPayloadOrderActionResult
...
class FinaticResponseOrderActionResult(BaseModel):
    ...
    success: Optional[SuccessPayloadOrderActionResult] = Field(default=None, description="Success payload containing data and optional meta. None when error is present.")
