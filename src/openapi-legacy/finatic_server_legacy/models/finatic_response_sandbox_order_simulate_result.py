...
from finatic_server_legacy.models.success_payload_sandbox_order_simulate_result import SuccessPayloadSandboxOrderSimulateResult
from typing import Optional, Set
from typing_extensions import Self
from pydantic_core import to_jsonable_python

class FinaticResponseSandboxOrderSimulateResult(BaseModel):
    """
    ...
    success: Optional[SuccessPayloadSandboxOrderSimulateResult] = Field(default=None, description="Success payload containing data and optional meta. None when error is present.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FinaticResponseSandboxOrderSimulateResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FinaticResponseSandboxOrderSimulateResult from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "error": obj.get("error"),
            "success": SuccessPayloadSandboxOrderSimulateResult.from_dict(obj["success"]) if obj.get("success") is not None else None,
