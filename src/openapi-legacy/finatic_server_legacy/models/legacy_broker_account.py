...
class LegacyBrokerAccount(BaseModel):
    ...
    """ # noqa: E501
    account_classification: Optional[StrictStr] = Field(default=None, description="Account classification", alias="accountClassification")
    account_created_at: Optional[datetime] = Field(default=None, description="Account created at", alias="accountCreatedAt")
    account_first_trade_at: Optional[datetime] = Field(default=None, description="Account first trade at", alias="accountFirstTradeAt")
    ...
    account_updated_at: Optional[datetime] = Field(default=None, description="Account updated at", alias="accountUpdatedAt")
    balances_synced_at: Optional[datetime] = Field(default=None, description="Balances synced at", alias="balancesSyncedAt")
    broker_id: Optional[StrictStr] = Field(default=None, description="Broker ID", alias="brokerId")
    broker_name: Optional[StrictStr] = Field(default=None, description="Broker name", alias="brokerName")
    connection_id: Optional[StrictStr] = Field(default=None, description="Connection ID", alias="connectionId")
    ...
    institution_id: Optional[StrictStr] = Field(default=None, description="Institution ID", alias="institutionId")
    last_synced_at: Optional[datetime] = Field(default=None, description="Last synced at from live account or connection metadata; not sourced from sandbox.sandbox_accounts", alias="lastSyncedAt")
    orders_synced_at: Optional[datetime] = Field(default=None, description="Orders synced at", alias="ordersSyncedAt")
    positions_synced_at: Optional[datetime] = Field(default=None, description="Positions synced at", alias="positionsSyncedAt")
    sub_account_type: Optional[StrictStr] = Field(default=None, description="Sub account type", alias="subAccountType")
    ...
    __properties: ClassVar[List[str]] = ["accountClassification", "accountCreatedAt", "accountFirstTradeAt", "accountId", "accountName", "accountNumber", "accountStatus", "accountType", "accountUpdatedAt", "balancesSyncedAt", "brokerId", "brokerName", "connectionId", "createdAt", "currencyCode", "id", "institutionId", "lastSyncedAt", "ordersSyncedAt", "positionsSyncedAt", "subAccountType", "updatedAt", "userId"]
