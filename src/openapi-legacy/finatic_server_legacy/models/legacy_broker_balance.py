...
from finatic_server_legacy.models.availablebalance import Availablebalance
from finatic_server_legacy.models.availabletowithdraw import Availabletowithdraw
from finatic_server_legacy.models.buyingpower import Buyingpower
from finatic_server_legacy.models.cashbalance import Cashbalance
from finatic_server_legacy.models.currentbalance import Currentbalance
from finatic_server_legacy.models.initialmargin import Initialmargin
from finatic_server_legacy.models.maintenancemargin import Maintenancemargin
from finatic_server_legacy.models.netliquidationvalue import Netliquidationvalue
from finatic_server_legacy.models.pendingbalance import Pendingbalance
from finatic_server_legacy.models.totalcashvalue import Totalcashvalue
from finatic_server_legacy.models.totalrealizedpnl import Totalrealizedpnl
...
class LegacyBrokerBalance(BaseModel):
    ...
    balance_created_at: Optional[datetime] = Field(default=None, description="Balance as-of date, sourced from balance_created_at", alias="balanceCreatedAt")
    balance_id: StrictStr = Field(description="Balance UUID", alias="balanceId")
    balance_name: Optional[StrictStr] = Field(default=None, description="Balance name", alias="balanceName")
    balance_type: Optional[StrictStr] = Field(default=None, description="Balance type", alias="balanceType")
    ...
    internal_account_id: Optional[StrictStr] = Field(default=None, description="Internal account UUID", alias="internalAccountId")
    ...
    __properties: ClassVar[List[str]] = ["accountId", "availableBalance", "availableToWithdraw", "balanceCreatedAt", "balanceId", "balanceName", "balanceType", "buyingPower", "cashBalance", "connectionId", "currencyCode", "currentBalance", "initialMargin", "internalAccountId", "lastUpdated", "maintenanceMargin", "netLiquidationValue", "pendingBalance", "totalCashValue", "totalRealizedPnl"]
