...
class NinjaTraderFutureStopLimitOrderPlaceQueryParams(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["accountSpec", "action", "activationTime", "assetType", "isAutomated", "limitPrice", "orderQty", "orderType", "pegDifference", "stopPrice", "symbol", "text", "timeInForce"]
