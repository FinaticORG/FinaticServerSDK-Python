...
class NinjaTraderFutureTrailingStopOrderPlaceQueryParams(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["accountSpec", "action", "activationTime", "assetType", "isAutomated", "orderQty", "orderType", "pegDifference", "stopPrice", "symbol", "text", "timeInForce", "trailPercent", "trailPrice"]
