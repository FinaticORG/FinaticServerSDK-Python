...
from finatic_server_legacy.models.order_modify_query_params_base_time_in_force import OrderModifyQueryParamsBaseTimeInForce
...
class OrderModifyQueryParamsBase(BaseModel):
    ...
    is_automated: Optional[StrictBool] = Field(default=None, description="Indicates algorithmic/automated order source (optional)", alias="isAutomated")
    order_id: Optional[StrictStr] = Field(default=None, description="Broker-assigned order identifier", alias="orderId")
    ...
    __properties: ClassVar[List[str]] = ["assetType", "isAutomated", "orderId", "orderQty", "orderType", "price", "stopPrice", "timeInForce"]
