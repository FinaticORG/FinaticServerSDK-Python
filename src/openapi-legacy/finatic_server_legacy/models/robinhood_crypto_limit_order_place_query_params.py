...
class RobinhoodCryptoLimitOrderPlaceQueryParams(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["action", "amountIn", "assetType", "orderQty", "orderType", "price", "symbol", "timeInForce"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RobinhoodCryptoLimitOrderPlaceQueryParams from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RobinhoodCryptoLimitOrderPlaceQueryParams from a dict"""
        if obj is None:
            return None
