...
class RobinhoodCryptoStopOrderPlaceQueryParams(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["action", "amountIn", "assetType", "orderQty", "orderType", "stopPrice", "symbol", "timeInForce"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RobinhoodCryptoStopOrderPlaceQueryParams from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RobinhoodCryptoStopOrderPlaceQueryParams from a dict"""
        if obj is None:
            return None
