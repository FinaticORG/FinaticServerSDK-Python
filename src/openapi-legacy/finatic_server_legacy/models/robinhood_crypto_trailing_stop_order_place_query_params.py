...
from finatic_server_legacy.models.orderqty1 import Orderqty1
...
class RobinhoodCryptoTrailingStopOrderPlaceQueryParams(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["action", "amountIn", "assetType", "orderQty", "orderType", "stopPrice", "symbol", "timeInForce", "trailPercent", "trailPrice"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "orderQty": Orderqty1.from_dict(obj["orderQty"]) if obj.get("orderQty") is not None else None,
