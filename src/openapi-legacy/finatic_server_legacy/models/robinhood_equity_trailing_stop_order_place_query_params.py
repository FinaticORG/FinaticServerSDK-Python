...
from finatic_server_legacy.models.orderqty2 import Orderqty2
...
class RobinhoodEquityTrailingStopOrderPlaceQueryParams(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["action", "assetType", "extendedHours", "marketHours", "orderQty", "orderType", "stopPrice", "symbol", "timeInForce", "trailPercent", "trailPrice"]
