...
class RobinhoodOptionLimitOrderPlaceQueryParams(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["action", "assetType", "creditOrDebit", "direction", "expirationDate", "optionType", "orderQty", "orderType", "positionEffect", "price", "spread", "strikePrice", "symbol", "timeInForce"]
