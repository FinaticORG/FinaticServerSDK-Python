...
class RobinhoodOptionStopLimitOrderPlaceQueryParams(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["action", "assetType", "creditOrDebit", "direction", "expirationDate", "limitPrice", "optionType", "orderQty", "orderType", "positionEffect", "spread", "stopPrice", "strikePrice", "symbol", "timeInForce"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RobinhoodOptionStopLimitOrderPlaceQueryParams from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RobinhoodOptionStopLimitOrderPlaceQueryParams from a dict"""
        if obj is None:
            return None
