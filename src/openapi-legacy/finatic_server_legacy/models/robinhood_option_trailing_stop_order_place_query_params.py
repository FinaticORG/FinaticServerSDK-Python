...
from finatic_server_legacy.models.robinhood_option_spread_leg import RobinhoodOptionSpreadLeg
...
class RobinhoodOptionTrailingStopOrderPlaceQueryParams(BaseModel):
    ...
    credit_or_debit: Optional[StrictStr] = Field(default=None, description="Credit or debit for single-leg option orders", alias="creditOrDebit")
    direction: Optional[StrictStr] = Field(default=None, description="Direction for option spread orders (debit/credit)")
    expiration_date: Optional[StrictStr] = Field(default=None, description="Option expiration date (YYYY-MM-DD format)", alias="expirationDate")
    option_type: Optional[StrictStr] = Field(default=None, description="Option type (call/put/both)", alias="optionType")
    order_qty: Annotated[int, Field(strict=True, gt=0)] = Field(alias="orderQty")
    order_type: StrictStr = Field(alias="orderType")
    position_effect: Optional[StrictStr] = Field(default=None, description="Position effect for single-leg option orders", alias="positionEffect")
    spread: Optional[List[RobinhoodOptionSpreadLeg]] = Field(default=None, description="Spread legs for order_option_spread()")
    stop_price: Union[StrictFloat, StrictInt] = Field(alias="stopPrice")
    strike_price: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Option strike price", alias="strikePrice")
    symbol: StrictStr
    ...
    __properties: ClassVar[List[str]] = ["action", "assetType", "creditOrDebit", "direction", "expirationDate", "optionType", "orderQty", "orderType", "positionEffect", "spread", "stopPrice", "strikePrice", "symbol", "timeInForce", "trailPercent", "trailPrice"]
