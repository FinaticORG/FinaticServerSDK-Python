...
class SuccessPayloadListFDXAccountGrant(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SuccessPayloadListFDXAccountGrant from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SuccessPayloadListFDXAccountGrant from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "_id": obj.get("_id"),
            "data": [FDXAccountGrant.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "meta": obj.get("meta")
        })
        return _obj
