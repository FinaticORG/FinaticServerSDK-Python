...
class TastyTradeEquityMarketOrderPlaceQueryParams(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["action", "assetType", "automated-source", "external-identifier", "orderQty", "orderType", "partition-key", "preflight-id", "price-effect", "source", "symbol", "timeInForce", "value-effect"]
