...
class TastyTradeEquityTrailingStopOrderPlaceQueryParams(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["action", "assetType", "automated-source", "external-identifier", "orderQty", "orderType", "partition-key", "preflight-id", "price-effect", "source", "stopPrice", "symbol", "timeInForce", "trailPercent", "trailPrice", "value-effect"]
