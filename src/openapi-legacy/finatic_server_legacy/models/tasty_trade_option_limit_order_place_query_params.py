...
class TastyTradeOptionLimitOrderPlaceQueryParams(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["action", "assetType", "automated-source", "expirationDate", "external-identifier", "optionType", "orderQty", "orderType", "partition-key", "positionEffect", "preflight-id", "price", "price-effect", "source", "strikePrice", "symbol", "timeInForce", "value-effect"]
