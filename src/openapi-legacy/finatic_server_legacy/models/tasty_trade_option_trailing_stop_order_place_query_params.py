...
class TastyTradeOptionTrailingStopOrderPlaceQueryParams(BaseModel):
    ...
    position_effect: Optional[StrictStr] = Field(default='open', description="Position effect for the option leg.", alias="positionEffect")
    ...
    strike_price: Union[StrictFloat, StrictInt] = Field(description="Option strike price.", alias="strikePrice")
    symbol: StrictStr
    ...
    __properties: ClassVar[List[str]] = ["action", "assetType", "automated-source", "expirationDate", "external-identifier", "optionType", "orderQty", "orderType", "partition-key", "positionEffect", "preflight-id", "price-effect", "source", "stopPrice", "strikePrice", "symbol", "timeInForce", "trailPercent", "trailPrice", "value-effect"]
