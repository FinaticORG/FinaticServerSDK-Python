...
from finatic_server_legacy.models.order_modify_query_params_base import OrderModifyQueryParamsBase
from typing import Optional, Set
from typing_extensions import Self
from pydantic_core import to_jsonable_python

class TastyTradeOrderModifyRequest(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TastyTradeOrderModifyRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TastyTradeOrderModifyRequest from a dict"""
        if obj is None:
            return None
