...
class TradestationFutureLimitOrderPlaceQueryParams(BaseModel):
    ...
    route: Optional[StrictStr] = Field(default=None, description="Route from Get Routes with FUTURE in AssetTypes; optional.")
    symbol: StrictStr
    time_in_force: Timeinforce = Field(alias="timeInForce")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["accountId", "action", "assetType", "orderQty", "orderType", "price", "route", "symbol", "timeInForce"]
