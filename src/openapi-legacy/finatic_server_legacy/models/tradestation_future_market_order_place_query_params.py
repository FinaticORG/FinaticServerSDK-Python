...
class TradestationFutureMarketOrderPlaceQueryParams(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["accountId", "action", "assetType", "orderQty", "orderType", "route", "symbol", "timeInForce"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TradestationFutureMarketOrderPlaceQueryParams from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TradestationFutureMarketOrderPlaceQueryParams from a dict"""
        if obj is None:
            return None
