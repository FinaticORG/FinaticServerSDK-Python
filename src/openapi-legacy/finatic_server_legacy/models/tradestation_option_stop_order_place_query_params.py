...
class TradestationOptionStopOrderPlaceQueryParams(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["accountId", "action", "assetType", "optionRouteKind", "orderQty", "orderType", "route", "stopPrice", "symbol", "timeInForce"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TradestationOptionStopOrderPlaceQueryParams from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TradestationOptionStopOrderPlaceQueryParams from a dict"""
        if obj is None:
            return None
