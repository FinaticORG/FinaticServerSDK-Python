...
from finatic_server_legacy.models.orderqty3 import Orderqty3
...
class Trading212StopLimitOrderPlaceQueryParams(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["action", "assetType", "extendedHours", "limitPrice", "orderQty", "orderType", "stopPrice", "symbol", "timeInForce"]
