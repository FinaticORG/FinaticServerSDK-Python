...
class WebullOptionLimitOrderPlaceQueryParams(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["action", "assetType", "clientOrderId", "creditOrDebit", "expirationDate", "optionType", "orderQty", "orderType", "positionEffect", "price", "strikePrice", "supportTradingSession", "symbol", "timeInForce"]
