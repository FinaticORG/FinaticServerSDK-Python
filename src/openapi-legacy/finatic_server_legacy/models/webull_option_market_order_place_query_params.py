...
class WebullOptionMarketOrderPlaceQueryParams(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["action", "assetType", "clientOrderId", "creditOrDebit", "expirationDate", "optionType", "orderQty", "orderType", "positionEffect", "strikePrice", "supportTradingSession", "symbol", "timeInForce"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WebullOptionMarketOrderPlaceQueryParams from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WebullOptionMarketOrderPlaceQueryParams from a dict"""
        if obj is None:
            return None
