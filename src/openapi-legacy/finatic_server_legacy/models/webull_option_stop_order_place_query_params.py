...
from finatic_server_legacy.models.broker_data_option_type_enum import BrokerDataOptionTypeEnum
from finatic_server_legacy.models.strikeprice1 import Strikeprice1
from finatic_server_legacy.models.timeinforce import Timeinforce
from typing import Optional, Set
from typing_extensions import Self
from pydantic_core import to_jsonable_python

class WebullOptionStopOrderPlaceQueryParams(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["action", "assetType", "clientOrderId", "creditOrDebit", "expirationDate", "optionType", "orderQty", "orderType", "positionEffect", "stopPrice", "strikePrice", "supportTradingSession", "symbol", "timeInForce"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WebullOptionStopOrderPlaceQueryParams from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WebullOptionStopOrderPlaceQueryParams from a dict"""
        if obj is None:
            return None
