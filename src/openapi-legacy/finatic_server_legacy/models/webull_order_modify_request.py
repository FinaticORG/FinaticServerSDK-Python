...
from finatic_server_legacy.models.order6 import Order6
from typing import Optional, Set
from typing_extensions import Self
from pydantic_core import to_jsonable_python

class WebullOrderModifyRequest(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WebullOrderModifyRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WebullOrderModifyRequest from a dict"""
        if obj is None:
            return None
