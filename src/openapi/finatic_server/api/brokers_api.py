...
class BrokersApi:
    ...
    async def cancel_order_api_beta_brokers_orders_order_id_delete(
        self,
        order_id: Annotated[
            StrictStr, Field(description="Broker-provided order ID to cancel")
        ],
        cancel_order_api_beta_brokers_orders_order_id_delete_request: Optional[
            CancelOrderApiBetaBrokersOrdersOrderIdDeleteRequest
        ] = None,
    ...
    async def get_accounts_api_beta_brokers_data_accounts_get(
        self,
        broker_id: Annotated[
            Optional[StrictStr], Field(description="Filter by broker ID")
        ] = None,
        connection_id: Annotated[
            Optional[UUID], Field(description="Filter by connection ID")
        ] = None,
        account_type: Annotated[
            Optional[Any],
            Field(
                description="Filter by account type (e.g., 'margin', 'cash', 'crypto_wallet', 'live', 'sim')"
            ),
        ] = None,
        currency: Annotated[
            Optional[StrictStr],
            Field(description="Filter by currency (e.g., 'USD', 'EUR')"),
        ] = None,
        limit: Annotated[
            Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]],
            Field(description="Maximum number of accounts to return"),
        ] = None,
        offset: Annotated[
            Optional[Annotated[int, Field(strict=True, ge=0)]],
            Field(description="Number of accounts to skip for pagination"),
        ] = None,
        include_metadata: Annotated[
            Optional[StrictBool],
            Field(
                description="Include connection metadata in response (excluded by default for FDX compliance)"
            ),
        ] = None,
        _request_timeout: Union[
            None,
    ...
    async def get_balances_api_beta_brokers_data_balances_get(
        ...
        account_id: Annotated[
            Optional[StrictStr],
            Field(
                description="Filter by broker provided account ID or internal account UUID"
            ),
        ] = None,
        unit_code: Annotated[
            Optional[StrictStr],
            Field(
                description="Filter by unit code (preferred, e.g., 'USD', 'BTC', 'ETH')"
            ),
        ] = None,
        currency: Annotated[
            Optional[StrictStr],
            Field(
                description="Filter by currency (for FDX fiat filtering only, e.g., 'USD', 'EUR')"
            ),
        ] = None,
        limit: Annotated[
            Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]],
            Field(description="Maximum number of balances to return"),
        ] = None,
        offset: Annotated[
            Optional[Annotated[int, Field(strict=True, ge=0)]],
            Field(description="Number of balances to skip for pagination"),
        ] = None,
        include_metadata: Annotated[
            Optional[StrictBool],
            Field(
                description="Include balance metadata in response (excluded by default for FDX compliance)"
            ),
        ] = None,
        _request_timeout: Union[
            None,
    ...
    async def get_order_events_api_beta_brokers_data_orders_order_id_events_get(
        ...
        offset: Annotated[
            Optional[Annotated[int, Field(strict=True, ge=0)]],
            Field(description="Number of events to skip for pagination"),
        ] = None,
        include_metadata: Annotated[
            Optional[StrictBool],
            Field(
                description="Include event metadata in response (excluded by default for FDX compliance)"
            ),
        ] = None,
        _request_timeout: Union[
            None,
    ...
    async def get_order_fills_api_beta_brokers_data_orders_order_id_fills_get(
        ...
        limit: Annotated[
            Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]],
            Field(description="Maximum number of fills to return"),
        ] = None,
        offset: Annotated[
            Optional[Annotated[int, Field(strict=True, ge=0)]],
            Field(description="Number of fills to skip for pagination"),
        ] = None,
        include_metadata: Annotated[
            Optional[StrictBool],
            Field(
                description="Include fill metadata in response (excluded by default for FDX compliance)"
            ),
        ] = None,
        _request_timeout: Union[
            None,
    ...
    async def get_order_groups_api_beta_brokers_data_orders_groups_get(
        ...
        limit: Annotated[
            Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]],
            Field(description="Maximum number of order groups to return"),
        ] = None,
        offset: Annotated[
            Optional[Annotated[int, Field(strict=True, ge=0)]],
            Field(description="Number of order groups to skip for pagination"),
        ] = None,
        created_after: Annotated[
            Optional[datetime],
            Field(description="Filter order groups created after this timestamp"),
        ] = None,
        created_before: Annotated[
            Optional[datetime],
            Field(description="Filter order groups created before this timestamp"),
        ] = None,
        include_metadata: Annotated[
            Optional[StrictBool],
            Field(
                description="Include group metadata in response (excluded by default for FDX compliance)"
            ),
        ] = None,
        _request_timeout: Union[
            None,
        ...
        _param = (
            self._get_order_groups_api_beta_brokers_data_orders_groups_get_serialize(
                broker_id=broker_id,
                connection_id=connection_id,
                limit=limit,
                offset=offset,
    ...
    async def get_orders_api_beta_brokers_data_orders_get(
        ...
        symbol: Annotated[
            Optional[StrictStr], Field(description="Filter by symbol")
        ] = None,
        order_status: Annotated[
            Optional[StrictStr],
            Field(
                description="Filter by order status (e.g., 'filled', 'pending_new', 'cancelled')"
            ),
        ] = None,
        side: Annotated[
            Optional[Any],
            Field(description="Filter by order side (e.g., 'buy', 'sell')"),
        ] = None,
        asset_type: Annotated[
            Optional[Any],
            Field(
                description="Filter by asset type (e.g., 'stock', 'option', 'crypto', 'future')"
            ),
        ] = None,
        limit: Annotated[
            Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]],
            Field(description="Maximum number of orders to return"),
        ] = None,
        offset: Annotated[
            Optional[Annotated[int, Field(strict=True, ge=0)]],
            Field(description="Number of orders to skip for pagination"),
        ] = None,
        created_after: Annotated[
            Optional[datetime],
            Field(
                description="Filter orders by effective creation time after this timestamp (broker order_created_at when set, otherwise row created_at)"
            ),
        ] = None,
        created_before: Annotated[
            Optional[datetime],
            Field(
                description="Filter orders by effective creation time before this timestamp (broker order_created_at when set, otherwise row created_at)"
            ),
        ] = None,
        include_metadata: Annotated[
            Optional[StrictBool],
            Field(
                description="Include order metadata in response (excluded by default for FDX compliance)"
            ),
        ] = None,
        _request_timeout: Union[
            None,
    ...
    async def get_position_lots_api_beta_brokers_data_positions_lots_get(
        ...
        account_id: Annotated[
            Optional[StrictStr],
            Field(description="Filter by broker provided account ID"),
        ] = None,
        symbol: Annotated[
            Optional[StrictStr], Field(description="Filter by symbol")
        ] = None,
        position_id: Annotated[
            Optional[UUID], Field(description="Filter by position ID")
        ] = None,
        limit: Annotated[
            Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]],
            Field(description="Maximum number of position lots to return"),
        ] = None,
        offset: Annotated[
            Optional[Annotated[int, Field(strict=True, ge=0)]],
            Field(description="Number of position lots to skip for pagination"),
        ] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _param = (
            self._get_position_lots_api_beta_brokers_data_positions_lots_get_serialize(
                broker_id=broker_id,
                connection_id=connection_id,
                account_id=account_id,
                symbol=symbol,
    ...
    async def get_positions_api_beta_brokers_data_positions_get(
        ...
        side: Annotated[
            Optional[Any],
            Field(description="Filter by position side (e.g., 'long', 'short')"),
        ] = None,
        asset_type: Annotated[
            Optional[Any],
            Field(
        ...
        position_status: Annotated[
            Optional[Any],
            Field(
                description="Filter by position status: 'active' (open positions) or 'closed' (closed positions). Use 'all' or omit to get both."
            ),
        ] = None,
        limit: Annotated[
            Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]],
            Field(description="Maximum number of positions to return"),
        ] = None,
        offset: Annotated[
            Optional[Annotated[int, Field(strict=True, ge=0)]],
            Field(description="Number of positions to skip for pagination"),
        ] = None,
        updated_after: Annotated[
            Optional[datetime],
            Field(description="Filter positions updated after this timestamp"),
        ] = None,
        updated_before: Annotated[
            Optional[datetime],
            Field(description="Filter positions updated before this timestamp"),
        ] = None,
        include_metadata: Annotated[
            Optional[StrictBool],
            Field(
                description="Include position metadata in response (excluded by default for FDX compliance)"
            ),
        ] = None,
        _request_timeout: Union[
            None,
    ...
    async def get_transactions_api_beta_brokers_data_transactions_get(
        ...
        transaction_type: Annotated[
            Optional[StrictStr],
            Field(
                description="Filter by transaction type (e.g., 'DEPOSIT', 'WITHDRAWAL', 'DIVIDEND')"
            ),
        ] = None,
        start_date: Annotated[
            Optional[datetime],
            Field(description="Filter transactions from this date (ISO 8601)"),
        ] = None,
        end_date: Annotated[
            Optional[datetime],
            Field(description="Filter transactions until this date (ISO 8601)"),
        ] = None,
        limit: Annotated[
            Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]],
        ...
        offset: Annotated[
            Optional[Annotated[int, Field(strict=True, ge=0)]],
            Field(description="Number of transactions to skip for pagination"),
        ] = None,
        before_transaction_date: Annotated[
            Optional[datetime],
            Field(
                description="Keyset pagination: `transaction_date` of the **last** row from the previous page. Must be sent with `before_transaction_id`. When set, `offset` must be `0`."
            ),
        ] = None,
        before_transaction_id: Annotated[
            Optional[UUID],
            Field(
                description="Keyset pagination: internal transaction `id` (UUID) of the **last** row from the previous page. Must be sent with `before_transaction_date`."
            ),
        ] = None,
        include_raw_payload: Annotated[
            Optional[StrictBool],
            Field(
                description="Load `raw_payload` JSONB from the database (slower). Default false for list performance."
            ),
        ] = None,
        _request_timeout: Union[
            None,
        ...
        _param = (
            self._get_transactions_api_beta_brokers_data_transactions_get_serialize(
                broker_id=broker_id,
                connection_id=connection_id,
                account_id=account_id,
                unit_code=unit_code,
    ...
    async def list_broker_connections_api_beta_brokers_connections_get(
        ...
        _param = (
            self._list_broker_connections_api_beta_brokers_connections_get_serialize(
                _request_auth=_request_auth,
                _content_type=_content_type,
                _headers=_headers,
                _host_index=_host_index,
    ...
    async def modify_order_api_beta_brokers_orders_order_id_patch(
        self,
        order_id: Annotated[
            StrictStr, Field(description="Broker-provided order ID to modify")
        ],
        order_request: OrderRequest,
        connection_id: Annotated[
            Optional[UUID],
            Field(
                description="Temporary bypass for testing: specify connection ID directly"
            ),
        ] = None,
        _request_timeout: Union[
            None,
    ...
    async def place_order_api_beta_brokers_orders_post(
        ...
        place_order_api_beta_brokers_orders_post_request: Optional[
            PlaceOrderApiBetaBrokersOrdersPostRequest
        ] = None,
        _request_timeout: Union[
            None,
