...
class Accounts(BaseModel):
    ...
    __properties: ClassVar[List[str]] = [
        ...
        "sandbox_key_created_at",
        "sandbox_key_expires_at",
        "sandbox_key_last_used_at",
        "slug",
        "terms_accepted_at",
        "trading_enabled",
        "trading_usage_description",
        "updated_at",
        "updated_by",
        "use_case_features",
    ]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # and model_fields_set contains the field
        if (
            self.api_key_created_at is None
            and "api_key_created_at" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.api_key_expires_at is None
            and "api_key_expires_at" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.api_key_last_used_at is None
            and "api_key_last_used_at" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.compliance_agreement is None
            and "compliance_agreement" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.onboarding_completed is None
            and "onboarding_completed" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.sandbox_api_key_hash is None
            and "sandbox_api_key_hash" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.sandbox_key_created_at is None
            and "sandbox_key_created_at" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.sandbox_key_expires_at is None
            and "sandbox_key_expires_at" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.sandbox_key_last_used_at is None
            and "sandbox_key_last_used_at" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.terms_accepted_at is None
            and "terms_accepted_at" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.trading_usage_description is None
            and "trading_usage_description" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.use_case_features is None
            and "use_case_features" in self.model_fields_set
        ):
