...
class AlpacaCryptoLimitOrderPlaceQueryParams(BaseModel):
    """
    Crypto limit order.
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["orderType", "assetType", "action", "timeInForce", "symbol", "orderQty", "price", "client_order_id", "order_class", "notional"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AlpacaCryptoLimitOrderPlaceQueryParams from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AlpacaCryptoLimitOrderPlaceQueryParams from a dict"""
        if obj is None:
            return None
