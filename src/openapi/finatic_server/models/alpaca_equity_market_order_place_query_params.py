...
class AlpacaEquityMarketOrderPlaceQueryParams(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["orderType", "assetType", "action", "timeInForce", "symbol", "orderQty", "client_order_id", "extended_hours", "order_class", "notional", "take_profit", "stop_loss", "trail_percent", "trail_price", "legs"]
