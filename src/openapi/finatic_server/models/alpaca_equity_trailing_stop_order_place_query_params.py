...
class AlpacaEquityTrailingStopOrderPlaceQueryParams(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["orderType", "assetType", "action", "timeInForce", "symbol", "orderQty", "stopPrice", "trail_percent", "trail_price", "client_order_id", "extended_hours", "order_class", "notional", "take_profit", "stop_loss", "legs"]
