...
class BetaBrokerShimResponse(BaseModel):
    """
    Machine-readable migration metadata for beta broker compatibility.
    """ # noqa: E501
    beta_path: StrictStr = Field(alias="betaPath")
    migration_status: Optional[StrictStr] = Field(default='compatibility_shim', alias="migrationStatus")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BetaBrokerShimResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BetaBrokerShimResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "betaPath": obj.get("betaPath"),
            "migrationStatus": obj.get("migrationStatus") if obj.get("migrationStatus") is not None else 'compatibility_shim',
            "notes": obj.get("notes"),
            "replacementMethod": obj.get("replacementMethod"),
