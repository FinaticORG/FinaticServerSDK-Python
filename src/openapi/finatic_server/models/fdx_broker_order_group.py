...
from finatic_server.models.grouptype import Grouptype
...
class FDXBrokerOrderGroup(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["_id", "completedAt", "connectionId", "createdAt", "groupStatus", "groupType", "metadata", "orderGroupId", "orders", "updatedAt"]
