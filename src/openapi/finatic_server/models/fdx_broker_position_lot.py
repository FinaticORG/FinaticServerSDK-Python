...
from finatic_server.models.closedquantity import Closedquantity
from finatic_server.models.closepriceavg import Closepriceavg
from finatic_server.models.costbasis1 import Costbasis1
from finatic_server.models.costbasiswithcommission1 import Costbasiswithcommission1
from finatic_server.models.fdx_broker_position_lot_fill import FDXBrokerPositionLotFill
from finatic_server.models.fdx_instrument_descriptor import FDXInstrumentDescriptor
from finatic_server.models.openprice import Openprice
from finatic_server.models.openquantity import Openquantity
from finatic_server.models.realizedprofitloss1 import Realizedprofitloss1
from finatic_server.models.realizedprofitlosswithcommission1 import Realizedprofitlosswithcommission1
from finatic_server.models.remainingquantity import Remainingquantity
from finatic_server.models.side2 import Side2
...
class FDXBrokerPositionLot(BaseModel):
    ...
    remaining_quantity: Remainingquantity = Field(alias="remainingQuantity")
    security_id: StrictStr = Field(description="Security identifier", alias="securityId")
    side: Optional[Side2] = None
    __properties: ClassVar[List[str]] = ["_id", "accountId", "assetType", "closePriceAvg", "closedAt", "closedQuantity", "connectionId", "costBasis", "costBasisWithCommission", "instrument", "internalAccountId", "lotId", "metadata", "openPrice", "openQuantity", "openedAt", "positionId", "positionLotFills", "realizedProfitLoss", "realizedProfitLossWithCommission", "remainingQuantity", "securityId", "side"]
