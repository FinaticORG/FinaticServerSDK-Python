...
class FinaticBrokerFactoryCoreStandardModelsAbstractResponsesFinaticResponseSessionResponseData2(
    BaseModel
):
    """
    ...
    success: Optional[SuccessPayloadSessionResponseData] = Field(
        default=None,
        ...
        _obj = cls.model_validate(
            {
                ...
                "success": (
                    SuccessPayloadSessionResponseData.from_dict(obj["success"])
