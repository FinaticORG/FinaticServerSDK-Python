...
class FinaticBrokerFactoryCoreStandardModelsAbstractResponsesFinaticResponseSessionUserResponse2(
    BaseModel
):
    """
    ...
    success: Optional[SuccessPayloadSessionUserResponse] = Field(
        default=None,
    ...
    warning: Optional[List[Dict[str, Any]]] = Field(
        default=None, description="Optional array of warning objects"
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FinaticBrokerFactoryCoreStandardModelsAbstractResponsesFinaticResponseSessionUserResponse2 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FinaticBrokerFactoryCoreStandardModelsAbstractResponsesFinaticResponseSessionUserResponse2 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "trace_id": (
                    obj.get("trace_id") if obj.get("trace_id") is not None else ""
                ),
                "success": (
                    SuccessPayloadSessionUserResponse.from_dict(obj["success"])
