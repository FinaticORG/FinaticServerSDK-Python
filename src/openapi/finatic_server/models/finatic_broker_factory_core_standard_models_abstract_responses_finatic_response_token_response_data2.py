...
class FinaticBrokerFactoryCoreStandardModelsAbstractResponsesFinaticResponseTokenResponseData2(
    BaseModel
):
    """
    ...
    success: Optional[SuccessPayloadTokenResponseData] = Field(
        default=None,
        ...
        _obj = cls.model_validate(
            {
                ...
                "success": (
                    SuccessPayloadTokenResponseData.from_dict(obj["success"])
