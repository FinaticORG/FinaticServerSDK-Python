...
from finatic_server.models.success_payload_fdx_broker_order import SuccessPayloadFDXBrokerOrder
from typing import Optional, Set
from typing_extensions import Self

class FinaticResponseFDXBrokerOrder(BaseModel):
    """
    FinaticResponseFDXBrokerOrder
    """ # noqa: E501
    error: Optional[Dict[str, Any]] = None
    success: Optional[SuccessPayloadFDXBrokerOrder] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FinaticResponseFDXBrokerOrder from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FinaticResponseFDXBrokerOrder from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "error": obj.get("error"),
            "success": SuccessPayloadFDXBrokerOrder.from_dict(obj["success"]) if obj.get("success") is not None else None,
