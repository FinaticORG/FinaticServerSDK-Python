...
class LegacyBrokerAccount(BaseModel):
    ...
    account_name: Optional[StrictStr] = Field(
        default=None, description="Account name", alias="accountName"
    )
    account_type: Optional[StrictStr] = Field(
        default=None, description="Account type", alias="accountType"
    )
    broker_id: Optional[StrictStr] = Field(
        default=None, description="Broker ID", alias="brokerId"
    )
    broker_name: Optional[StrictStr] = Field(
        default=None, description="Broker name", alias="brokerName"
    )
    institution_id: Optional[StrictStr] = Field(
        default=None, description="Institution ID", alias="institutionId"
    )
    ...
    account_status: Optional[StrictStr] = Field(
        default=None, description="Account status", alias="accountStatus"
    )
    sub_account_type: Optional[StrictStr] = Field(
        default=None, description="Sub account type", alias="subAccountType"
    )
    account_classification: Optional[StrictStr] = Field(
        default=None,
        description="Account classification",
        alias="accountClassification",
    )
    ...
    created_at: Optional[datetime] = Field(
        default=None, description="Created at", alias="createdAt"
    )
    updated_at: Optional[datetime] = Field(
        default=None, description="Updated at", alias="updatedAt"
    )
    account_created_at: Optional[datetime] = Field(
        default=None, description="Account created at", alias="accountCreatedAt"
    )
    account_updated_at: Optional[datetime] = Field(
        default=None, description="Account updated at", alias="accountUpdatedAt"
    )
    account_first_trade_at: Optional[datetime] = Field(
        default=None, description="Account first trade at", alias="accountFirstTradeAt"
    )
    last_synced_at: Optional[datetime] = Field(
        default=None, description="Last synced at", alias="lastSyncedAt"
    )
    balances_synced_at: Optional[datetime] = Field(
        default=None, description="Balances synced at", alias="balancesSyncedAt"
    )
    orders_synced_at: Optional[datetime] = Field(
        default=None, description="Orders synced at", alias="ordersSyncedAt"
    )
    positions_synced_at: Optional[datetime] = Field(
        default=None, description="Positions synced at", alias="positionsSyncedAt"
    )
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # and model_fields_set contains the field
        if (
            self.sub_account_type is None
            and "sub_account_type" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.account_classification is None
            and "account_classification" in self.model_fields_set
        ):
