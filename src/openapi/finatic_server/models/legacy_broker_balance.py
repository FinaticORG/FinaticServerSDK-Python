...
class LegacyBrokerBalance(BaseModel):
    ...
    account_id: StrictStr = Field(
        description="Broker-provided account ID", alias="accountId"
    )
    internal_account_id: Optional[StrictStr] = Field(
        default=None, description="Internal account UUID", alias="internalAccountId"
    )
    connection_id: Optional[StrictStr] = Field(
        default=None, description="Connection ID", alias="connectionId"
    )
    balance_type: Optional[StrictStr] = Field(
        default=None, description="Balance type", alias="balanceType"
    )
    balance_name: Optional[StrictStr] = Field(
        default=None, description="Balance name", alias="balanceName"
    )
    available_balance: Optional[Availablebalance] = Field(
        default=None, alias="availableBalance"
    )
    current_balance: Optional[Currentbalance] = Field(
        default=None, alias="currentBalance"
    )
    pending_balance: Optional[Pendingbalance] = Field(
        default=None, alias="pendingBalance"
    )
    ...
    net_liquidation_value: Optional[Netliquidationvalue] = Field(
        default=None, alias="netLiquidationValue"
    )
    initial_margin: Optional[Initialmargin] = Field(default=None, alias="initialMargin")
    maintenance_margin: Optional[Maintenancemargin] = Field(
        default=None, alias="maintenanceMargin"
    )
    total_cash_value: Optional[Totalcashvalue] = Field(
        default=None, alias="totalCashValue"
    )
    available_to_withdraw: Optional[Availabletowithdraw] = Field(
        default=None, alias="availableToWithdraw"
    )
    total_realized_pnl: Optional[Totalrealizedpnl] = Field(
        default=None, alias="totalRealizedPnl"
    )
    currency_code: Optional[StrictStr] = Field(
        default=None, description="Currency code", alias="currencyCode"
    )
    balance_created_at: Optional[datetime] = Field(
        default=None,
        description="Balance as-of date, sourced from balance_created_at",
        alias="balanceCreatedAt",
    )
    last_updated: Optional[datetime] = Field(
        default=None, description="Last updated", alias="lastUpdated"
    )
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        if (
            self.internal_account_id is None
            and "internal_account_id" in self.model_fields_set
        ):
        ...
        if (
            ...
            and "available_balance" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.net_liquidation_value is None
            and "net_liquidation_value" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.maintenance_margin is None
            and "maintenance_margin" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.total_cash_value is None
            and "total_cash_value" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.available_to_withdraw is None
            and "available_to_withdraw" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.total_realized_pnl is None
            and "total_realized_pnl" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.balance_created_at is None
            and "balance_created_at" in self.model_fields_set
        ):
            _dict["balanceCreatedAt"] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "availableBalance": (
                    Availablebalance.from_dict(obj["availableBalance"])
                    if obj.get("availableBalance") is not None
                    else None
                ),
                "currentBalance": (
                    Currentbalance.from_dict(obj["currentBalance"])
                    if obj.get("currentBalance") is not None
                    else None
                ),
                "pendingBalance": (
                    Pendingbalance.from_dict(obj["pendingBalance"])
                    if obj.get("pendingBalance") is not None
                    else None
                ),
                "buyingPower": (
                    Buyingpower.from_dict(obj["buyingPower"])
                    if obj.get("buyingPower") is not None
                    else None
                ),
                "cashBalance": (
                    Cashbalance.from_dict(obj["cashBalance"])
                    if obj.get("cashBalance") is not None
                    else None
                ),
                "netLiquidationValue": (
                    Netliquidationvalue.from_dict(obj["netLiquidationValue"])
                    if obj.get("netLiquidationValue") is not None
                    else None
                ),
                "initialMargin": (
                    Initialmargin.from_dict(obj["initialMargin"])
                    if obj.get("initialMargin") is not None
                    else None
                ),
                "maintenanceMargin": (
                    Maintenancemargin.from_dict(obj["maintenanceMargin"])
                    if obj.get("maintenanceMargin") is not None
                    else None
                ),
                "totalCashValue": (
                    Totalcashvalue.from_dict(obj["totalCashValue"])
                    if obj.get("totalCashValue") is not None
                    else None
                ),
                "availableToWithdraw": (
                    Availabletowithdraw.from_dict(obj["availableToWithdraw"])
                    if obj.get("availableToWithdraw") is not None
                    else None
                ),
                "totalRealizedPnl": (
                    Totalrealizedpnl.from_dict(obj["totalRealizedPnl"])
                    if obj.get("totalRealizedPnl") is not None
                    else None
                ),
                "currencyCode": obj.get("currencyCode"),
                "balanceCreatedAt": obj.get("balanceCreatedAt"),
