...
class OAuthCompletionResponse(BaseModel):
    """
    OAuth callback completion metadata for the Connect portal.
    """ # noqa: E501
    broker_id: StrictStr
    error: Optional[StrictStr] = None
    error_description: Optional[StrictStr] = None
    outcome: StrictStr
    __properties: ClassVar[List[str]] = ["broker_id", "error", "error_description", "outcome"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OAuthCompletionResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OAuthCompletionResponse from a dict"""
        if obj is None:
            return None
