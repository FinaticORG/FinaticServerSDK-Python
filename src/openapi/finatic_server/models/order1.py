...
class Order1(BaseModel):
    ...
    oneof_schema_1_validator: Optional[NinjaTraderFutureMarketOrderPlaceQueryParams] = (
        None
    )
    # data type: NinjaTraderFutureLimitOrderPlaceQueryParams
    oneof_schema_2_validator: Optional[NinjaTraderFutureLimitOrderPlaceQueryParams] = (
        None
    )
    # data type: NinjaTraderFutureStopOrderPlaceQueryParams
    oneof_schema_3_validator: Optional[NinjaTraderFutureStopOrderPlaceQueryParams] = (
        None
    )
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        if not isinstance(v, NinjaTraderFutureMarketOrderPlaceQueryParams):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `NinjaTraderFutureMarketOrderPlaceQueryParams`"
            )
        else:
            match += 1
        ...
        if not isinstance(v, NinjaTraderFutureLimitOrderPlaceQueryParams):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `NinjaTraderFutureLimitOrderPlaceQueryParams`"
            )
        else:
            match += 1
        ...
        if not isinstance(v, NinjaTraderFutureStopOrderPlaceQueryParams):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `NinjaTraderFutureStopOrderPlaceQueryParams`"
            )
        else:
            match += 1
        ...
        if not isinstance(v, NinjaTraderFutureStopLimitOrderPlaceQueryParams):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `NinjaTraderFutureStopLimitOrderPlaceQueryParams`"
            )
        else:
            match += 1
        ...
        if not isinstance(v, NinjaTraderFutureTrailingStopOrderPlaceQueryParams):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `NinjaTraderFutureTrailingStopOrderPlaceQueryParams`"
            )
        else:
            match += 1
        if match > 1:
            # more than 1 match
            raise ValueError(
                "Multiple matches found when setting `actual_instance` in Order1 with oneOf schemas: NinjaTraderFutureLimitOrderPlaceQueryParams, NinjaTraderFutureMarketOrderPlaceQueryParams, NinjaTraderFutureStopLimitOrderPlaceQueryParams, NinjaTraderFutureStopOrderPlaceQueryParams, NinjaTraderFutureTrailingStopOrderPlaceQueryParams. Details: "
                + ", ".join(error_messages)
            )
        elif match == 0:
            # no match
            raise ValueError(
                "No match found when setting `actual_instance` in Order1 with oneOf schemas: NinjaTraderFutureLimitOrderPlaceQueryParams, NinjaTraderFutureMarketOrderPlaceQueryParams, NinjaTraderFutureStopLimitOrderPlaceQueryParams, NinjaTraderFutureStopOrderPlaceQueryParams, NinjaTraderFutureTrailingStopOrderPlaceQueryParams. Details: "
                + ", ".join(error_messages)
            )
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if _data_type == "limit":
            instance.actual_instance = (
                NinjaTraderFutureLimitOrderPlaceQueryParams.from_json(json_str)
            )
            return instance
        ...
        if _data_type == "market":
            instance.actual_instance = (
                NinjaTraderFutureMarketOrderPlaceQueryParams.from_json(json_str)
            )
            return instance
        ...
        if _data_type == "stop":
            instance.actual_instance = (
                NinjaTraderFutureStopOrderPlaceQueryParams.from_json(json_str)
            )
            return instance
        ...
        if _data_type == "stop_limit":
            instance.actual_instance = (
                NinjaTraderFutureStopLimitOrderPlaceQueryParams.from_json(json_str)
            )
            return instance
        ...
        if _data_type == "trailing_stop":
            instance.actual_instance = (
                NinjaTraderFutureTrailingStopOrderPlaceQueryParams.from_json(json_str)
            )
            return instance
