...
class Order2AnyOf(BaseModel):
    ...
    oneof_schema_1_validator: Optional[RobinhoodEquityMarketOrderPlaceQueryParams] = (
        None
    )
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        if not isinstance(v, RobinhoodEquityMarketOrderPlaceQueryParams):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `RobinhoodEquityMarketOrderPlaceQueryParams`"
            )
        else:
            match += 1
        ...
        if not isinstance(v, RobinhoodEquityLimitOrderPlaceQueryParams):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `RobinhoodEquityLimitOrderPlaceQueryParams`"
            )
        else:
            match += 1
        ...
        if not isinstance(v, RobinhoodEquityStopOrderPlaceQueryParams):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `RobinhoodEquityStopOrderPlaceQueryParams`"
            )
        else:
            match += 1
        ...
        if not isinstance(v, RobinhoodEquityStopLimitOrderPlaceQueryParams):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `RobinhoodEquityStopLimitOrderPlaceQueryParams`"
            )
        else:
            match += 1
        ...
        if not isinstance(v, RobinhoodEquityTrailingStopOrderPlaceQueryParams):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `RobinhoodEquityTrailingStopOrderPlaceQueryParams`"
            )
        else:
            match += 1
        if match > 1:
            # more than 1 match
            raise ValueError(
                "Multiple matches found when setting `actual_instance` in Order2AnyOf with oneOf schemas: RobinhoodEquityLimitOrderPlaceQueryParams, RobinhoodEquityMarketOrderPlaceQueryParams, RobinhoodEquityStopLimitOrderPlaceQueryParams, RobinhoodEquityStopOrderPlaceQueryParams, RobinhoodEquityTrailingStopOrderPlaceQueryParams. Details: "
                + ", ".join(error_messages)
            )
        elif match == 0:
            # no match
            raise ValueError(
                "No match found when setting `actual_instance` in Order2AnyOf with oneOf schemas: RobinhoodEquityLimitOrderPlaceQueryParams, RobinhoodEquityMarketOrderPlaceQueryParams, RobinhoodEquityStopLimitOrderPlaceQueryParams, RobinhoodEquityStopOrderPlaceQueryParams, RobinhoodEquityTrailingStopOrderPlaceQueryParams. Details: "
                + ", ".join(error_messages)
            )
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if _data_type == "limit":
            instance.actual_instance = (
                RobinhoodEquityLimitOrderPlaceQueryParams.from_json(json_str)
            )
            return instance
        ...
        if _data_type == "market":
            instance.actual_instance = (
                RobinhoodEquityMarketOrderPlaceQueryParams.from_json(json_str)
            )
            return instance
        ...
        if _data_type == "stop":
            instance.actual_instance = (
                RobinhoodEquityStopOrderPlaceQueryParams.from_json(json_str)
            )
            return instance
        ...
        if _data_type == "stop_limit":
            instance.actual_instance = (
                RobinhoodEquityStopLimitOrderPlaceQueryParams.from_json(json_str)
            )
            return instance
        ...
        if _data_type == "trailing_stop":
            instance.actual_instance = (
                RobinhoodEquityTrailingStopOrderPlaceQueryParams.from_json(json_str)
            )
            return instance
