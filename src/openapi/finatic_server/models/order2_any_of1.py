...
class Order2AnyOf1(BaseModel):
    ...
    oneof_schema_1_validator: Optional[RobinhoodOptionMarketOrderPlaceQueryParams] = (
        None
    )
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        if not isinstance(v, RobinhoodOptionMarketOrderPlaceQueryParams):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `RobinhoodOptionMarketOrderPlaceQueryParams`"
            )
        else:
            match += 1
        ...
        if not isinstance(v, RobinhoodOptionLimitOrderPlaceQueryParams):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `RobinhoodOptionLimitOrderPlaceQueryParams`"
            )
        else:
            match += 1
        ...
        if not isinstance(v, RobinhoodOptionStopOrderPlaceQueryParams):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `RobinhoodOptionStopOrderPlaceQueryParams`"
            )
        else:
            match += 1
        ...
        if not isinstance(v, RobinhoodOptionStopLimitOrderPlaceQueryParams):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `RobinhoodOptionStopLimitOrderPlaceQueryParams`"
            )
        else:
            match += 1
        ...
        if not isinstance(v, RobinhoodOptionTrailingStopOrderPlaceQueryParams):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `RobinhoodOptionTrailingStopOrderPlaceQueryParams`"
            )
        else:
            match += 1
        if match > 1:
            # more than 1 match
            raise ValueError(
                "Multiple matches found when setting `actual_instance` in Order2AnyOf1 with oneOf schemas: RobinhoodOptionLimitOrderPlaceQueryParams, RobinhoodOptionMarketOrderPlaceQueryParams, RobinhoodOptionStopLimitOrderPlaceQueryParams, RobinhoodOptionStopOrderPlaceQueryParams, RobinhoodOptionTrailingStopOrderPlaceQueryParams. Details: "
                + ", ".join(error_messages)
            )
        elif match == 0:
            # no match
            raise ValueError(
                "No match found when setting `actual_instance` in Order2AnyOf1 with oneOf schemas: RobinhoodOptionLimitOrderPlaceQueryParams, RobinhoodOptionMarketOrderPlaceQueryParams, RobinhoodOptionStopLimitOrderPlaceQueryParams, RobinhoodOptionStopOrderPlaceQueryParams, RobinhoodOptionTrailingStopOrderPlaceQueryParams. Details: "
                + ", ".join(error_messages)
            )
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if _data_type == "limit":
            instance.actual_instance = (
                RobinhoodOptionLimitOrderPlaceQueryParams.from_json(json_str)
            )
            return instance
        ...
        if _data_type == "market":
            instance.actual_instance = (
                RobinhoodOptionMarketOrderPlaceQueryParams.from_json(json_str)
            )
            return instance
        ...
        if _data_type == "stop":
            instance.actual_instance = (
                RobinhoodOptionStopOrderPlaceQueryParams.from_json(json_str)
            )
            return instance
        ...
        if _data_type == "stop_limit":
            instance.actual_instance = (
                RobinhoodOptionStopLimitOrderPlaceQueryParams.from_json(json_str)
            )
            return instance
        ...
        if _data_type == "trailing_stop":
            instance.actual_instance = (
                RobinhoodOptionTrailingStopOrderPlaceQueryParams.from_json(json_str)
            )
            return instance
