...
class Order2AnyOf2(BaseModel):
    ...
    oneof_schema_1_validator: Optional[RobinhoodCryptoMarketOrderPlaceQueryParams] = (
        None
    )
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        if not isinstance(v, RobinhoodCryptoMarketOrderPlaceQueryParams):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `RobinhoodCryptoMarketOrderPlaceQueryParams`"
            )
        else:
            match += 1
        ...
        if not isinstance(v, RobinhoodCryptoLimitOrderPlaceQueryParams):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `RobinhoodCryptoLimitOrderPlaceQueryParams`"
            )
        else:
            match += 1
        ...
        if not isinstance(v, RobinhoodCryptoStopOrderPlaceQueryParams):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `RobinhoodCryptoStopOrderPlaceQueryParams`"
            )
        else:
            match += 1
        ...
        if not isinstance(v, RobinhoodCryptoStopLimitOrderPlaceQueryParams):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `RobinhoodCryptoStopLimitOrderPlaceQueryParams`"
            )
        else:
            match += 1
        ...
        if not isinstance(v, RobinhoodCryptoTrailingStopOrderPlaceQueryParams):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `RobinhoodCryptoTrailingStopOrderPlaceQueryParams`"
            )
        else:
            match += 1
        if match > 1:
            # more than 1 match
            raise ValueError(
                "Multiple matches found when setting `actual_instance` in Order2AnyOf2 with oneOf schemas: RobinhoodCryptoLimitOrderPlaceQueryParams, RobinhoodCryptoMarketOrderPlaceQueryParams, RobinhoodCryptoStopLimitOrderPlaceQueryParams, RobinhoodCryptoStopOrderPlaceQueryParams, RobinhoodCryptoTrailingStopOrderPlaceQueryParams. Details: "
                + ", ".join(error_messages)
            )
        elif match == 0:
            # no match
            raise ValueError(
                "No match found when setting `actual_instance` in Order2AnyOf2 with oneOf schemas: RobinhoodCryptoLimitOrderPlaceQueryParams, RobinhoodCryptoMarketOrderPlaceQueryParams, RobinhoodCryptoStopLimitOrderPlaceQueryParams, RobinhoodCryptoStopOrderPlaceQueryParams, RobinhoodCryptoTrailingStopOrderPlaceQueryParams. Details: "
                + ", ".join(error_messages)
            )
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if _data_type == "limit":
            instance.actual_instance = (
                RobinhoodCryptoLimitOrderPlaceQueryParams.from_json(json_str)
            )
            return instance
        ...
        if _data_type == "market":
            instance.actual_instance = (
                RobinhoodCryptoMarketOrderPlaceQueryParams.from_json(json_str)
            )
            return instance
        ...
        if _data_type == "stop":
            instance.actual_instance = (
                RobinhoodCryptoStopOrderPlaceQueryParams.from_json(json_str)
            )
            return instance
        ...
        if _data_type == "stop_limit":
            instance.actual_instance = (
                RobinhoodCryptoStopLimitOrderPlaceQueryParams.from_json(json_str)
            )
            return instance
        ...
        if _data_type == "trailing_stop":
            instance.actual_instance = (
                RobinhoodCryptoTrailingStopOrderPlaceQueryParams.from_json(json_str)
            )
            return instance
