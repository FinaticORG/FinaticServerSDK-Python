...
class PortalAccountGrantRequest(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PortalAccountGrantRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PortalAccountGrantRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "authAttemptId": obj.get("authAttemptId"),
            "canRead": obj.get("canRead") if obj.get("canRead") is not None else True,
            "canTrade": obj.get("canTrade") if obj.get("canTrade") is not None else False,
