...
class RobinhoodCryptoTrailingStopOrderPlaceQueryParams(BaseModel):
    ...
    amount_in: Optional[StrictStr] = Field(
        default="quantity",
        description="Whether quantityOrPrice represents quantity or price",
        alias="amountIn",
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "orderQty": (
                    Orderqty2.from_dict(obj["orderQty"])
                ...
                "amountIn": (
                    obj.get("amountIn")
                    if obj.get("amountIn") is not None
                    else "quantity"
                ),
            }
        )
