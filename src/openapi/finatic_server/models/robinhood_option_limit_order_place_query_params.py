...
class RobinhoodOptionLimitOrderPlaceQueryParams(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["orderType", "assetType", "action", "timeInForce", "symbol", "orderQty", "price", "direction", "spread", "positionEffect", "creditOrDebit", "expirationDate", "strikePrice", "optionType"]
