...
class RobinhoodOptionStopLimitOrderPlaceQueryParams(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["orderType", "assetType", "action", "timeInForce", "symbol", "orderQty", "stopPrice", "limitPrice", "direction", "spread", "positionEffect", "creditOrDebit", "expirationDate", "strikePrice", "optionType"]
