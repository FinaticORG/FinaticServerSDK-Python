...
class RobinhoodOptionTrailingStopOrderPlaceQueryParams(BaseModel):
    ...
    direction: Optional[StrictStr] = Field(
        default=None, description="Direction for option spread orders (debit/credit)"
    )
    spread: Optional[List[RobinhoodOptionSpreadLeg]] = Field(
        default=None, description="Spread legs for order_option_spread()"
    )
    position_effect: Optional[StrictStr] = Field(
        default=None,
        description="Position effect for single-leg option orders",
        alias="positionEffect",
    )
    credit_or_debit: Optional[StrictStr] = Field(
        default=None,
        description="Credit or debit for single-leg option orders",
        alias="creditOrDebit",
    )
    ...
    strike_price: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, description="Option strike price", alias="strikePrice"
    )
    option_type: Optional[StrictStr] = Field(
        default=None, description="Option type (call/put/both)", alias="optionType"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "spread": (
                    [
                        RobinhoodOptionSpreadLeg.from_dict(_item)
                        for _item in obj["spread"]
                    ]
