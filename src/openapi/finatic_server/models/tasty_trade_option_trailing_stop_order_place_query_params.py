...
class TastyTradeOptionTrailingStopOrderPlaceQueryParams(BaseModel):
    ...
    automated_source: Optional[StrictBool] = Field(
        default=True, alias="automated-source"
    )
    ...
    ] = Field(default=None, alias="external-identifier")
    ...
    strike_price: Union[StrictFloat, StrictInt] = Field(
        description="Option strike price.", alias="strikePrice"
    )
    option_type: StrictStr = Field(
        description="Option type (call or put).", alias="optionType"
    )
    position_effect: Optional[StrictStr] = Field(
        default="open",
        description="Position effect for the option leg.",
        ...
        _obj = cls.model_validate(
            {
                ...
                "automated-source": (
                    obj.get("automated-source")
                    if obj.get("automated-source") is not None
                    else True
                ),
                ...
                "positionEffect": (
                    obj.get("positionEffect")
                    if obj.get("positionEffect") is not None
                    else "open"
                ),
            }
        )
