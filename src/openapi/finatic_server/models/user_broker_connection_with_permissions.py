...
class UserBrokerConnectionWithPermissions(BaseModel):
    ...
    user_id: UUID
    __properties: ClassVar[List[str]] = ["broker_id", "connection_metadata", "created_at", "id", "last_synced_at", "permissions", "push_agent_connector_state", "push_agent_last_heartbeat_at", "requires_customer_agent", "status", "updated_at", "user_id"]
