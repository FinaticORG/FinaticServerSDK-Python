...
def append_theme_to_url(
    base_url: str, theme: str | dict[str, Any] | None = None
) -> str:
    ...
    try:
        ...
        if isinstance(theme, str):
            ...
            if theme.get("preset"):
                ...
                # Custom theme
                encoded_theme = base64.b64encode(
                    json.dumps(theme["custom"]).encode()
                ).decode()
...
def append_broker_filter_to_url(
    base_url: str, broker_names: list[str] | None = None
) -> str:
...
def append_asset_types_to_url(
    base_url: str, asset_types: list[str] | None = None
) -> str:
